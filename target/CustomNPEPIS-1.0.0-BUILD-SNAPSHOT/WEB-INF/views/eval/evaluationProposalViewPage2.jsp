				...
				<table style="width: 100%">
					...
					<tr>
						...
						<td colspan="5">
							<table style="width: 40%;">
								<tr>
									<td>
										<input type="text" name="opr_dept_6" id="opr_dept_6" readonly="readonly" value="${commDetail.opr_dept_6}">
										<input type="hidden" name="opr_dept_seq_6" id="opr_dept_seq_6" value="${commDetail.opr_dept_seq_6}">
										<input type="text" name="opr_emp_name_6" id="opr_emp_name_6" style="width: 70px;" readonly="readonly" value="${commDetail.opr_emp_name_6}">
										<input type="hidden" name="opr_emp_seq_6" id="opr_emp_seq_6" value="${commDetail.opr_emp_seq_6}">
										<img alt="" src="../Images/btn/search_icon2.png" style="cursor: pointer;" onclick="userSearchPopup(2, 6);">
									</td>
									<td>
										<input type="text" name="opr_dept_7" id="opr_dept_7" readonly="readonly" value="${commDetail.opr_dept_7}">
										<input type="hidden" name="opr_dept_seq_7" id="opr_dept_seq_7" value="${commDetail.opr_dept_seq_7}">
										<input type="text" name="opr_emp_name_7" id="opr_emp_name_7" style="width: 70px;" readonly="readonly" value="${commDetail.opr_emp_name_7}">
										<input type="hidden" name="opr_emp_seq_7" id="opr_emp_seq_7" value="${commDetail.opr_emp_seq_7}">
										<img alt="" src="../Images/btn/search_icon2.png" style="cursor: pointer;" onclick="userSearchPopup(2, 7);">
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="join_org_cnt" id="join_org_cnt" style="width: 50px;"><input type="button" value="등록" onclick="joinOrgBtn();">
						</td>
						<td colspan="5">
							<table style="width: 100%;">
								<colgroup>
