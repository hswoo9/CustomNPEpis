...
<div class="pop_sign_wrap" style="width:999px;">
		...
		<div class="psh_btnbox">
			...
			<div class="psh_right">
				<div class="btn_cen mt8">
				    ...
				    <input type="button" class="psh_btn" id="btnReferConfer" value="<%=BizboxAMessage.getMessage("TX000005358","참조품의 가져오기")%>" />
    ...
    <div class="pop_sign_con " style="padding:62px 16px 20px 16px;">
    	<div class="btn_div m0">
    		<div class="left_div">
    			 <p class="tit_p mt20 mb0" id="coInfo"></p>
    		</div>
    		
    		<div class="right_div" style="margin:15px 29px 0 0;">
    			<div id="divCustomBusan">
    				<span class="" style="margin-right:5px;">회계발의일</span> 
    				<span><input style="width:119px;" id="txtAcisuDate" class="non-requirement" tabindex="103"  part="user" /></span>
    			</div>
    		</div>
    	</div>	
        ...
        <div id="erpUserInfo-table">
            ...
            <dl class="dl2">
                <dt><%=BizboxAMessage.getMessage("TX000009435","결의부서/작성자")%></dt>
            ...
            <dl class="dl2">
                <dt style="margin-left:35px;"><%=BizboxAMessage.getMessage("TX000009894","결의일자")%></dt>
...
<!-- 		원인행위 사용여부에 따라  -->
        ...
        <div class="controll_btn mt10 p0">
            ...
            <span class="cl fr" id="referConfer" style="display:none"></span><br>
        </div>
        ...
        <div class="com_ta2 mt15 scroll_on" style="height:200px;">
			<table style="width:966px;" id="erpTradeInfo">
				<thead>
					<tr>
					    <th width="150" id="thTradeTrNm"><%=BizboxAMessage.getMessage("TX000000313","거래처명")%></th>    <!-- 1, 2(기타소득자) , 3(사원명), 4, 5(사업소득자)-->
			            <th width="80"><%=BizboxAMessage.getMessage("TX000000026","대표자명")%></th>   <!-- 1 -->                                                                                                   
			            <th width="100" id="thTradeUnitAm"><%=BizboxAMessage.getMessage("TX000000552","금액")%></th>      <!-- 1, 2(지급총액), 3(지급총액) , 4-->                                                                                                          
			            <th width="100" id="thTradeSupAm"><%=BizboxAMessage.getMessage("TX000000516","공급가액")%></th>    <!-- 1, 2(실수령액), 3(실수령액) , 4-->                                                                                                            
			            <th width="100" id="thTradeVatAm"><%=BizboxAMessage.getMessage("TX000000517","부가세")%></th>     <!-- 1, 2(원천징수액), 3(원천징수액), 4 --> 
		...
		<table id="erpTradeInfo-tablesample" style="display:none">
		    <tr class="">
		        <td width="150" id="trade-td">
					...
					<input type="hidden" class="non-requirement" id="txt_ITEM_NM" />
					<input type="hidden" class="non-requirement" id="txt_ITEM_CNT" />
					<input type="hidden" class="non-requirement" id="txt_ITEM_AM" />
				...
				<td width="100"><input style="width:93%;" id="txt_TAX_DT"  class="non-requirement enter" tabindex="20011" part="trade" />
