...
Pudd.Element.Control=Pudd.invent({init:function(t){this.containerObj=null,this.toolTipObj=null,this.infoMsgObj=null,this.optObject=null,this.constructor.call(this,t)},inherit:Pudd.Element,extend:{setupContainer:function(){var t=document.createElement("div");this.before(t),t.appendChild(this.node),this.containerObj=new Pudd.Element(t),this.containerObj.addClass(Pudd.Config.className.PUDD),this.containerObj.addClass(pudding.skinName),this.removeClass("puddSetup")},parseOption:function(t,i){if(t)t.attributes=t.attributes?t.attributes:null,t.controlAttributes=t.controlAttributes?t.controlAttributes:null,t.disabled=!0===t.disabled,t.iconSvg=Pudd.Fn.getCodeIconSvg(t.iconSvg),t.info="string"==typeof t.info?t.info.toLowerCase().trim():null,t.infoMsg="string"==typeof t.infoMsg?t.infoMsg:null,t.tooltip="boolean"==typeof t.tooltip&&t.tooltip,t.tooltipMsg="string"==typeof t.tooltipMsg?t.tooltipMsg.trim():null,i&&"function"==typeof i&&(t=i.call(this,t,!0));else{t={attributes:null};var o=this.attr("pudd-style");o&&"string"==typeof o&&""!=o&&(t.attributes={},t.attributes.style=o);var s=this.attr("pudd-class");s&&"string"==typeof s&&""!=s&&(t.attributes||(t.attributes={}),t.attributes.class=s),t.disabled=!1,null!=this.attr("disabled")&&(t.disabled=!0),t.iconSvg=Pudd.Fn.getCodeIconSvg(this.attr("pudd-icon-svg")),t.info=null;var n=this.attr("pudd-info");n&&"string"==typeof n&&""!=n&&(t.info=n.toLowerCase().trim()),t.infoMsg=null;var e=this.attr("pudd-info-msg");e&&"string"==typeof e&&""!=e&&(t.infoMsg=e.trim()),t.tooltip=!1;var a=this.attr("pudd-tooltip");a&&"string"==typeof a&&"true"==a.toLowerCase().trim()&&(t.tooltip=!0),t.tooltipMsg=this.attr("pudd-tooltip-msg"),i&&"function"==typeof i&&(t=i.call(this,t,!1))}return t},setupAttributes:function(t){if(this.optObject&&this.optObject.attributes){var i=this.optObject.attributes;if(t&&"object"==typeof t&&t instanceof Pudd.Element)for(var o in i)"style"==o?t.style(i[o]):"class"==o?t.addClass(i[o]):t.attr(o,i[o]);else if(this.containerObj)for(var o in i)"style"==o?this.containerObj.style(i[o]):"class"==o?this.containerObj.addClass(i[o]):this.containerObj.attr(o,i[o])}},setupControlAttributes:function(t){if(this.optObject&&this.optObject.controlAttributes){var i=this.optObject.controlAttributes;for(var o in t&&"object"==typeof t&&t instanceof Pudd.Element||(t=this),i)"style"==o?t.style(i[o]):t.attr(o,i[o])}},setupIconSvg:function(t){if(this.optObject){var i=this.optObject.iconSvg;i&&(this.insertHTML(i),t&&"function"==typeof t&&t.call(this))}},setupInfoMsg:function(){this.optObject&&this.optObject.info&&(infoStr=this.optObject.info,"success"==infoStr?this.containerObj.addClass(Pudd.Config.className.Success):"error"==infoStr?this.containerObj.addClass(Pudd.Config.className.Error):"warning"==infoStr&&this.containerObj.addClass(Pudd.Config.className.Warning),this.optObject.infoMsg&&""!=this.optObject.infoMsg&&this.processInfoMsg(this.optObject.infoMsg))},processInfoMsg:function(t){if(this.containerObj){var i=document.createElement("div");this.containerObj.append(i);var o=document.createTextNode(t);i.appendChild(o),this.infoMsgObj=new Pudd.Element(i),this.infoMsgObj.addClass("informationText"),this.infoMsgObj.addClass("animated03s"),this.infoMsgObj.addClass("fadeInRight")}},setupToolTip:function(){this.optObject&&this.optObject.tooltip&&null!=this.optObject.tooltipMsg&&this.processToolTip(this.optObject.tooltipMsg)},processToolTip:function(t){(new Pudd.Util.ToolTip).initToolTip(this.containerObj,t)},show:function(){return this.style("display:block;"),this.containerObj.style("display",null),this},hide:function(){return this.style("display:none;"),this.containerObj.style("display:none;"),this},setupControlEventCallback:function(){if(this.optObject.eventCallback&&"object"==typeof this.optObject.eventCallback)for(var o in this.optObject.eventCallback)if("function"==typeof this.optObject.eventCallback[o]){var s=this,n=this.optObject.eventCallback[o];!function(){var t=o,i=n;s.on(t,function(t){i.call(s,t)})}()}}}});
Pudd.Element.Control.TextBox=Pudd.invent({init:function(t){this.anchorSearchObj=null,this.autoCompleteCall=!1,this.listBox=null,this.btnUpObj=null,this.btnDownObj=null,this.intervalKey=0,this.btnMouseDownING=!1,this.constructor.call(this,t)},inherit:Pudd.Element.Control,extend:{setup:function(t){if(this.setupContainer(),this.optObject=this.parseOption(t,function(t,e){if(e)"string"==typeof t.inputType?t.inputType="search"==t.inputType.toLowerCase().trim()?"search":null:t.inputType=null,t.fnSearch&&"function"==typeof t.fnSearch||(t.fnSearch=null),t.autoCompleteCallback&&"function"==typeof t.autoCompleteCallback||(t.autoCompleteCallback=null),t.readonly=!0===t.readonly,t.readonly&&this.attr("readonly","readonly"),t.disabled&&this.attr("disabled","disabled"),t.value=t.value||"",this.attr("value",t.value),t.stepper&&"object"==typeof t.stepper&&t.stepper.use?(t.stepper.unitValue=parseInt(t.stepper.unitValue,10),isNaN(t.stepper.unitValue)&&(t.stepper.unitValue=1),t.stepper.minValue=parseInt(t.stepper.minValue,10),isNaN(t.stepper.minValue)&&(t.stepper.minValue=0),t.stepper.maxValue=parseInt(t.stepper.maxValue,10),isNaN(t.stepper.maxValue)&&(t.stepper.maxValue=null)):t.stepper=null;else{t.inputType=null;var i=this.attr("pudd-input-type");i&&"string"==typeof i&&"search"==i.toLowerCase().trim()&&(t.inputType="search"),t.fnSearch=null,t.autoCompleteCallback=null,t.readonly=!1,null!=this.attr("readonly")&&(t.readonly=!0),t.value=this.attr("value")||"",t.stepper=null}return t}),this.setupAttributes(),this.setupControlAttributes(),this.optObject.stepper){this.containerObj.addClass(Pudd.Config.className.PUDD_UI_Stepper),this.addClass("Stepper-TEXT");var e=Pudd.Fn.appendChildObj("div",this.containerObj,"Stepper-Button");this.btnUpObj=Pudd.Fn.appendChildObj("button",e,"Stepper-UP"),this.optObject.disabled&&this.btnUpObj.attr("disabled","disabled");Pudd.Fn.appendChildObj("span",this.btnUpObj,"Stepper-UP-span");this.btnDownObj=Pudd.Fn.appendChildObj("button",e,"Stepper-DOWN"),this.optObject.disabled&&this.btnDownObj.attr("disabled","disabled");Pudd.Fn.appendChildObj("span",this.btnDownObj,"Stepper-DOWN-span")}else{if("search"==this.optObject.inputType){this.containerObj.addClass(Pudd.Config.className.PUDD_UI_searchField);var i=document.createElement("a");this.containerObj.append(i),this.anchorSearchObj=new Pudd.Element(i),this.anchorSearchObj.insertHTML(Pudd.Config.svgSet.MAGNIFIER,!0),this.optObject.disabled||null==this.optObject.fnSearch||(this.anchorSearchObj.addClass("btn"),this.anchorSearchObj.attr("href","javascript:;"))}else this.containerObj.addClass(Pudd.Config.className.PUDD_UI_inputField),this.setupIconSvg();this.setupAutoComplete()}return this.setupInfoMsg(),this.setupToolTip(),this.setupEvent(),this.setupControlEventCallback(),this},setupAutoComplete:function(){this.optObject.autoCompleteCallback&&(this.listBox=new Pudd.Util.ListBox(this.containerObj.node),this.listBox.initListBox("autoComplete"))},setupEvent:function(){var e=this;if(this.anchorSearchObj&&this.anchorSearchObj.hasClass("btn")&&this.optObject.fnSearch&&this.anchorSearchObj.on("click",function(t){e.optObject.fnSearch.call(e)}),this.optObject.stepper&&(this.btnUpObj.on("mousedown",function(t){t.preventDefault(),this.btnMouseDownING=!0,window.setTimeout(function(){!e.intervalKey&&e.btnMouseDownING&&(e.intervalKey=window.setInterval(function(){e.intervalValue(!0)},80))},500)}.bind(this)),this.btnUpObj.on("mouseup",function(t){this.clearIntervalSet()}.bind(this)),this.btnUpObj.on("mouseout",function(t){this.clearIntervalSet()}.bind(this)),this.btnUpObj.on("click",function(t){this.clearIntervalSet(),this.increaseValue(!0)}.bind(this)),this.btnDownObj.on("mousedown",function(t){t.preventDefault(),this.btnMouseDownING=!0,window.setTimeout(function(){!e.intervalKey&&e.btnMouseDownING&&(e.intervalKey=window.setInterval(function(){e.intervalValue(!1)},80))},500)}.bind(this)),this.btnDownObj.on("mouseup",function(t){this.clearIntervalSet()}.bind(this)),this.btnDownObj.on("mouseout",function(t){this.clearIntervalSet()}.bind(this)),this.btnDownObj.on("click",function(t){this.clearIntervalSet(),this.increaseValue(!1)}.bind(this)),this.on("keydown",function(t){t.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_TOP?(t.preventDefault(),this.increaseValue(!0)):t.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM&&(t.preventDefault(),this.increaseValue(!1))}.bind(this)),this.on("keyup",function(t){if(t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_TOP&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ENTER&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ESCAPE&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_LEFT&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT){var e=this.val().trim();if(""!=e){var i=!1;Pudd.regex.isNumber.test(e)?i=!0:(e=parseInt(e,10),isNaN(e)?this.val(""):(i=!0,this.val(e))),i&&(e<this.optObject.stepper.minValue?this.val(this.optObject.stepper.minValue):null!==this.optObject.stepper.maxValue&&e>this.optObject.stepper.maxValue&&this.val(this.optObject.stepper.maxValue))}}}.bind(this))),this.listBox){this.on("keydown",function(t){t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_TOP&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ENTER&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ESCAPE&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_LEFT&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT&&this.optObject.autoCompleteCallback&&window.setTimeout(function(){this.autoCompleteProcess()}.bind(this),200)}.bind(this)),this.on("keyup",function(t){229!=t.keyCode?t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_TOP&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ENTER&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ESCAPE&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_LEFT&&(t.keyCode,Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT):t.preventDefault()}.bind(this));var t=Pudd.getInstance(document);t.on("keydown",function(t){this.node.parentNode&&this.listBox.getDisplayListBox()&&(t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_TOP&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ENTER&&t.keyCode!=Pudd.Config.const.ID_KEYCODE_ESCAPE||(t.preventDefault(),this.listBox.eventKeyDown(t),t.keyCode==Pudd.Config.const.ID_KEYCODE_ENTER||t.keyCode==Pudd.Config.const.ID_KEYCODE_ESCAPE&&this.listBox.showListBox(!1,null)))}.bind(this)),t.on("mousedown",function(t){if(this.node.parentNode&&!this.listBox.listObj.hover){if(!this.listBox.getDisplayListBox())return;this.listBox.showListBox(!1,null)}}.bind(this))}},clearIntervalSet:function(){this.btnMouseDownING=!1,this.intervalKey&&(window.clearInterval(this.intervalKey),this.intervalKey=null)},intervalValue:function(t){this.optObject.stepper&&this.btnMouseDownING&&this.intervalKey&&this.increaseValue(t)},increaseValue:function(t){if(this.optObject.stepper){var e=this.val().trim();if(""==e){if("number"!=typeof this.optObject.stepper.minValue)return;e=this.optObject.stepper.minValue}e=parseInt(e,10),isNaN(e)?"number"==typeof this.optObject.stepper.minValue&&(this.val(this.optObject.stepper.minValue),this.node.select()):(t?null===this.optObject.stepper.maxValue?this.val(e+this.optObject.stepper.unitValue):e+this.optObject.stepper.unitValue<=this.optObject.stepper.maxValue&&this.val(e+this.optObject.stepper.unitValue):e-this.optObject.stepper.unitValue>=this.optObject.stepper.minValue&&this.val(e-this.optObject.stepper.unitValue),this.node.select())}},autoCompleteProcess:function(){if(!this.autoCompleteCall){this.autoCompleteCall=!0,this.listBox.removeAllOptionItem();var t=this.val().trim();if(""!=t)this.optObject.autoCompleteCallback.call(this,t)||(this.autoCompleteCall=!1);else this.autoCompleteCall=!1}},autoCompleteResult:function(t,e){if(this.listBox.removeAllOptionItem(),e){var i=e.dataSource,n=e.dataValueField,s=e.dataTextField;if(i&&n&&s){var o=i.read(!0);if(0!=o.length){for(var a in o){var l=o[a],u=l[s];u=(u=u.replace(/</gi,"&lt;")).replace(/>/gi,"&gt;"),this.listBox.appendOptionItem(l[n],u,!0,null)}this.listBox.showListBox(!0,this),this.listBox.eventListBox(function(t,e){this.val(e),this.autoCompleteListClickCustomEvent(t,e)}.bind(this),function(t){}.bind(this),function(t){this.listBox.showListBox(!1,null)}.bind(this)),this.autoCompleteCall=!1}else this.autoCompleteCall=!1}else this.autoCompleteCall=!1}else this.autoCompleteCall=!1},autoCompleteListClickCustomEvent:function(t,e){var i={};i.value=t,i.text=e;var n=new CustomEvent("Event",{detail:i});n.initEvent("autoCompleteListClick",!0,!0),this.node.dispatchEvent(n)},setDisabled:function(t){t?(this.attr("disabled","true"),this.anchorSearchObj&&this.anchorSearchObj.removeClass("btn")):(this.attr("disabled",null),this.anchorSearchObj&&this.anchorSearchObj.addClass("btn")),this.optObject.stepper&&(t?(this.containerObj.addClass("disabled"),this.btnUpObj&&this.btnUpObj.attr("disabled","true"),this.btnDownObj&&this.btnDownObj.attr("disabled","true")):(this.containerObj.removeClass("disabled"),this.btnUpObj&&this.btnUpObj.attr("disabled",null),this.btnDownObj&&this.btnDownObj.attr("disabled",null)))}}});
...
Pudd.Element.Component.Calendar=Pudd.invent({init:function(e){this.dateObj=null,this.selectYear=null,this.selectMonth=null,this.curDateObj=null,this.userSelectedYear=null,this.userSelectedMonth=null,this.userSelectedDate=null,this.fnCallback=null,this.fnCallback_confirm=null,this.fnCallback_cancel=null,this.dateAnchorCollection=null,this.monthAnchorCollection=null,this.wrapperObj=null,this.selectAreaObj=null,this.dateTextObj=null,this.selectDateArr=["prevYear","prevMonth","nextMonth","nextYear"],this.selectDateObjArr=null,this.weekName=["일","월","화","수","목","금","토"],this.weekCnt=6,this.calendarTableObj=null,this.monthGroupObj=null,this.groupRowCnt=3,this.groupColCnt=4,this.infoBtnObj=null,this.keyPos=null,this.periodWrapObj=null,this.periodFromObj=null,this.periodToObj=null,this.periodParentObj=null,this.period_userSelectedYear=null,this.period_userSelectedMonth=null,this.period_userSelectedDate=null,this.period_fromYear=null,this.period_fromMonth=null,this.period_fromDate=null,this.period_toYear=null,this.period_toMonth=null,this.period_toDate=null,this.periodInfoTextObj=null,this.constructor.call(this,e)},inherit:Pudd.Element.Component,extend:{setup:function(e){if(this.setupContainer(),this.addClass(Pudd.Config.className.PUDD_UI_calendar),this.optObject=this.parseOption(e),3==this.optObject.displayType||4==this.optObject.displayType){this.period_setupWrapper(),4==this.optObject.displayType&&this.period_setupComplexButton();var t=document.createElement("div");Pudd(t).puddCalendar({displayType:"",value:this.optObject.startDate,showBottom:!1,periodSelect:!0}),this.periodWrapObj.append(t),this.periodFromObj=Pudd.getInstance(t),this.periodFromObj.node.className="",this.periodFromObj.wrapperObj.addClass("fromDate"),(this.periodFromObj.periodParentObj=this).periodFromObj.fromCalendar=!0;var s=document.createElement("div");Pudd(s).puddCalendar({displayType:"",value:this.optObject.endDate,showBottom:!1,periodSelect:!0}),this.periodWrapObj.append(s),this.periodToObj=Pudd.getInstance(s),this.periodToObj.node.className="",this.periodToObj.wrapperObj.addClass("toDate"),(this.periodToObj.periodParentObj=this).periodToObj.fromCalendar=!1,this.period_setupInfoArea();var i=new Date(this.optObject.startDate),a=new Date(this.optObject.endDate);i instanceof Date&&(this.period_fromYear=i.getFullYear(),this.period_fromMonth=i.getMonth()+1,this.period_fromDate=i.getDate(),this.period_reset_userSelected(this.periodFromObj)),a instanceof Date&&(this.period_toYear=a.getFullYear(),this.period_toMonth=a.getMonth()+1,this.period_toDate=a.getDate(),this.period_reset_userSelected(this.periodToObj)),this.period_switchAnchorClassProcess(this),"function"==typeof this.optObject.confirmCallback&&(this.fnCallback_confirm=this.optObject.confirmCallback),"function"==typeof this.optObject.cancelCallback&&(this.fnCallback_cancel=this.optObject.cancelCallback)}else this.initDate(this.optObject.displayType,this.optObject.value),this.setupWrapper(),this.selectDateObjArr=[],this.setupSelectArea(this.optObject.displayType),this.setupCalendarArea(this.optObject.displayType),this.optObject.showBottom&&(this.optObject.selectionRule&&("function"==typeof this.optObject.confirmCallback&&(this.fnCallback_confirm=this.optObject.confirmCallback),"function"==typeof this.optObject.cancelCallback&&(this.fnCallback_cancel=this.optObject.cancelCallback)),this.setupInfoArea(this.optObject.displayType)),this.setupEvent(this.optObject.displayType),"function"==typeof this.optObject.calendarCallback&&this.registerCallback(this.optObject.calendarCallback);return this},parseOption:function(e){if(e)e.typeDisplay="string"==typeof e.typeDisplay?e.typeDisplay.toLowerCase().trim():null,e.displayType=1,"month"==e.typeDisplay?e.displayType=2:"period"==e.typeDisplay?e.displayType=3:"complex"==e.typeDisplay&&(e.displayType=4),3!=e.displayType&&4!=e.displayType||(e.startDate="string"==typeof e.startDate?e.startDate:"",e.endDate="string"==typeof e.endDate?e.endDate:""),e.value="string"==typeof e.value?e.value:"",e.showBottom="boolean"!=typeof e.showBottom||e.showBottom,e.periodSelect="boolean"==typeof e.periodSelect&&e.periodSelect,e.selectionRule&&(e.selectionRule.startWeek=e.selectionRule.startWeek?e.selectionRule.startWeek:0);else{e={displayType:1};var t=this.attr("pudd-type-display");if(t&&"string"==typeof t&&("month"==(t=t.toLowerCase().trim())?e.displayType=2:"period"==t?e.displayType=3:"complex"==t&&(e.displayType=4),3==e.displayType||4==e.displayType)){e.startDate="";var s=this.attr("pudd-start-date");s&&"string"==typeof s&&(e.startDate=s.toLowerCase().trim()),e.endDate="";var i=this.attr("pudd-end-date");i&&"string"==typeof i&&(e.endDate=i.toLowerCase().trim())}e.value="";var a=this.attr("pudd-value");a&&"string"==typeof a&&(e.value=a.toLowerCase().trim()),e.showBottom=!0,e.periodSelect=!1}return e},initDate:function(e,t){if(this.dateObj||(this.dateObj=new Pudd.Util.Date),t){var s=t.split("-");1==e?3==s.length&&(this.dateObj.reset(parseInt(s[0],10),parseInt(s[1],10),parseInt(s[2],10)),this.userSelectedYear=this.dateObj.getYear(),this.userSelectedMonth=this.dateObj.getMonth(),this.userSelectedDate=this.dateObj.getDate()):2==e&&2==s.length&&(this.dateObj.reset(parseInt(s[0],10),parseInt(s[1],10),1),this.userSelectedYear=this.dateObj.getYear(),this.userSelectedMonth=this.dateObj.getMonth(),this.userSelectedDate=1)}this.selectYear=this.dateObj.getYear(),this.selectMonth=this.dateObj.getMonth(),1==e&&this.dateObj.getCalendarMatrix(),this.curDateObj=new Date},appendSpanChildProcess:function(e,t){var s=document.createElement("span");e.append(s),s.textContent=t},setupWrapper:function(){this.wrapperObj=Pudd.Fn.appendChildObj("div",this,"calendarWrap")},period_reset_userSelected:function(e){e.userSelectedYear=null,e.userSelectedMonth=null,e.userSelectedDate=null},period_setupWrapper:function(){this.periodWrapObj=Pudd.Fn.appendChildObj("div",this,"periodWrap")},period_setupComplexButton:function(){var e=Pudd.Fn.appendChildObj("div",this.periodWrapObj,"complexBtn"),t=Pudd.Fn.appendChildObj("div",e,"fnBtn"),s=Pudd.Fn.appendChildObj("div",t,"group1"),i=Pudd.Fn.appendChildObj("div",t,"group2"),a=Pudd.Fn.appendChildObj("div",t,"group3"),o=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(o,"오늘"),o.on("click",function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=t.getMonth(),a=t.getDate(),o=t.getFormatDateString();this.period_selection_process(o,o,s,i,a,s,i,a)}.bind(this));var n=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(n,"전일"),n.on("click",function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=t.getMonth(),a=t.getDate()-1;t.reset(s,i,a);var o=t.getFormatDateString();this.period_selection_process(o,o,s,i,a,s,i,a)}.bind(this));var r=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(r,"주간"),r.on("click",function(e){this.period_complexButtonClick_byWeek(0)}.bind(this));var l=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(l,"전주"),l.on("click",function(e){this.period_complexButtonClick_byWeek(-7)}.bind(this));var h=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(h,"당월"),h.on("click",function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=t.getMonth(),a=t.getDate();t.reset(s,i,1);var o=t.getFormatDateString();t.reset(s,i,a);var n=t.getFormatDateString();this.period_selection_process(o,n,s,i,1,s,i,a)}.bind(this));var d=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(d,"전월"),d.on("click",function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=t.getMonth();1==i?(year--,i=12):i--,t.reset(s,i,1);var a=t.getFormatDateString(),o=new Date(s,i,0).getDate();t.reset(s,i,o);var n=t.getFormatDateString();this.period_selection_process(a,n,s,i,1,s,i,o)}.bind(this));var c=Pudd.Fn.appendChildObj("a",s,"Btn");this.appendSpanChildProcess(c,"오늘까지"),c.on("click",function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=t.getMonth(),a=t.getDate(),o=t.getFormatDateString();t.reset(s,1,1);var n=t.getFormatDateString();this.period_selection_process(n,o,s,1,1,s,i,a)}.bind(this));var p=[],u=[];p[0]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(p[0],"1/4분기"),p[1]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(p[1],"2/4분기"),p[2]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(p[2],"3/4분기"),p[3]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(p[3],"4/4분기"),u[0]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(u[0],"상반기"),u[1]=Pudd.Fn.appendChildObj("a",i,"Btn"),this.appendSpanChildProcess(u[1],"하반기"),p.forEach(function(e,t){e.on("click",function(e){this.period_complexButtonClick_byQuarter(t)}.bind(this))}.bind(this)),u.forEach(function(e,t){e.on("click",function(e){this.period_complexButtonClick_byHalf(t)}.bind(this))}.bind(this));var f=[];f[0]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[0],"1월"),f[1]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[1],"2월"),f[2]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[2],"3월"),f[3]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[3],"4월"),f[4]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[4],"5월"),f[5]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[5],"6월"),f[6]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[6],"7월"),f[7]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[7],"8월"),f[8]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[8],"9월"),f[9]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[9],"10월"),f[10]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[10],"11월"),f[11]=Pudd.Fn.appendChildObj("a",a,"Btn"),this.appendSpanChildProcess(f[11],"12월"),f.forEach(function(e,t){e.on("click",function(e){this.period_complexButtonClick_byMonth(t)}.bind(this))}.bind(this))},period_complexButtonClick_byWeek:function(e){var t=new Date,s=t.getFullYear(),i=t.getMonth(),a=t.getDate(),o=t.getDay();t=new Date(s,i,a);for(var n=[],r=[],l=[],h=[],d=0;d<7;d++){var c=new Date(s,i,a+(d-o+e)),p=c.getFullYear(),u=Number(c.getMonth())+1,f=c.getDate();if(n[d]=p,r[d]=u,l[d]=f,u=1===String(u).length?"0"+u:u,f=1===String(f).length?"0"+f:f,h[d]=p+"-"+u+"-"+f,0==e)if(0==Pudd.Util.Date.compareDate(t,c))break}var b=h.length-1;this.period_selection_process(h[0],h[b],n[0],r[0],l[0],n[b],r[b],l[b])},period_complexButtonClick_byQuarter:function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=3*e+1,a=3*e+3,o=31;1!=e&&2!=e||(o=30),t.reset(s,i,1);var n=t.getFormatDateString();t.reset(s,a,o);var r=t.getFormatDateString();this.period_selection_process(n,r,s,i,1,s,a,o)},period_complexButtonClick_byHalf:function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=6*e+1,a=6*e+6,o=31;0==e&&(o=30),t.reset(s,i,1);var n=t.getFormatDateString();t.reset(s,a,o);var r=t.getFormatDateString();this.period_selection_process(n,r,s,i,1,s,a,o)},period_complexButtonClick_byMonth:function(e){var t=new Pudd.Util.Date,s=t.getYear(),i=e+1;t.reset(s,i,1);var a=t.getFormatDateString(),o=new Date(s,i,0).getDate();t.reset(s,i,o);var n=t.getFormatDateString();this.period_selection_process(a,n,s,i,1,s,i,o)},period_from_to_assign:function(e,t,s,i,a,o){this.period_fromYear=e,this.period_fromMonth=t,this.period_fromDate=s,this.period_toYear=i,this.period_toMonth=a,this.period_toDate=o},period_selection_process:function(e,t,s,i,a,o,n,r){this.periodFromObj.assignNewValue(e),this.periodToObj.assignNewValue(t),this.period_reset_userSelected(this.periodFromObj),this.period_reset_userSelected(this.periodToObj),this.period_from_to_assign(s,i,a,o,n,r),this.period_switchAnchorClassProcess(this)},setupSelectArea:function(a){this.selectAreaObj=Pudd.Fn.appendChildObj("div",this.wrapperObj,"selectDate"),this.dateTextObj=Pudd.Fn.appendChildObj("span",this.selectAreaObj,"dateText"),1==a?this.dateTextObj.text(this.dateObj.getYearString()+"."+this.dateObj.getMonthString()):2==a&&this.dateTextObj.text(this.dateObj.getYearString());var o=this;this.selectDateArr.forEach(function(e,t){var s=document.createElement("a");s.className=e;var i=document.createElement("span");i.className="arr",s.appendChild(i),o.selectAreaObj.append(s),o.selectDateObjArr[t]=new Pudd.Element(s),2==a&&("prevYear"!=e&&"nextYear"!=e||o.selectDateObjArr[t].hide())})},setupCalendarArea:function(e){var t=document.createElement("div");if(this.wrapperObj.append(t),1==e){t.className="calendarTable";var s=document.createElement("table");if(t.appendChild(s),this.calendarTableObj=new Pudd.Element(s),this.setupCalendarArea_week_name(s,e),this.setupCalendarArea_table(s,e),this.mappingCalendarArea_date(s,e),this.optObject.selectionRule){this.getAnchorCollection(e),this.clearAnchorClass(this.wrapperObj.node);var i=this.selectionRule_getWeek(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate,0,this.optObject.selectionRule.startWeek);this.selectionRule_selectAnchorClass(i)}}else 2==e&&(t.className="monthBtn",this.monthGroupObj=new Pudd.Element(t),this.setupCalendarArea_month(e),this.userSelectedYear=this.selectYear,this.userSelectedMonth=this.selectMonth,this.mappingCalendarArea_month(e))},setupCalendarArea_week_name:function(e,t){if(1==t){var s=document.createElement("tr");e.appendChild(s);for(var i=0;i<this.weekName.length;i++){var a=document.createElement("th");s.appendChild(a),a.textContent=this.weekName[i],0==i&&(a.className="sun")}}},setupCalendarArea_table:function(e,t){if(1==t)for(var s=0;s<this.weekCnt;s++){var i=document.createElement("tr");e.appendChild(i);for(var a=0;a<this.weekName.length;a++){var o=document.createElement("td");i.appendChild(o);var n=document.createElement("a");o.appendChild(n),n.style.height="20px",n.style.lineHeight="20px",n.setAttribute("href","javascript:;");var r=new Pudd.Element(n);r.row=s,r.col=a,new Pudd.Element(o).aObj=r}}},mappingCalendarArea_date:function(e,t){if(1==t)for(var s=this.curDateObj.getFullYear(),i=this.curDateObj.getMonth()+1,a=this.curDateObj.getDate(),o=1;o<e.rows.length;o++)for(var n=e.rows[o].cells.length,r=0;r<n;r++){var l=e.rows[o].cells[r],h=l.childNodes[0];l.className="";var d=o-1,c=r;h.textContent=this.dateObj.calendarMatrix[d][c],0==r?this.dateObj.calendarCurMatrix[d][c]?a==this.dateObj.calendarCurMatrix[d][c]&&this.selectYear==s&&this.selectMonth==i?l.className="sun today":l.className="sun":l.className="sun otherMonth":this.dateObj.calendarCurMatrix[d][c]?a==this.dateObj.calendarCurMatrix[d][c]&&this.selectYear==s&&this.selectMonth==i&&(l.className="today"):l.className="otherMonth",this.selectYear==this.userSelectedYear&&this.selectMonth==this.userSelectedMonth&&this.dateObj.calendarCurMatrix[d][c]==this.userSelectedDate?h.className="selected":h.className=""}},setupCalendarArea_month:function(e){if(2==e){this.curDateObj.getFullYear(),this.curDateObj.getMonth();for(var t=1,s=0;s<this.groupRowCnt;s++){var i=document.createElement("div");this.monthGroupObj.append(i),i.className="fnBtn";var a=document.createElement("div");i.appendChild(a),a.className="group";for(var o=0;o<this.groupColCnt;o++){var n=document.createElement("a");a.appendChild(n),n.className="Btn",new Pudd.Element(n).idx=t;var r=document.createElement("span");n.appendChild(r),r.textContent=t+++"월"}}}},mappingCalendarArea_month:function(e){if(2==e){this.getAnchorCollection(e);for(var t=0;t<this.monthAnchorCollection.length;t++)this.selectYear==this.userSelectedYear&&this.selectMonth==this.userSelectedMonth&&t==this.userSelectedMonth-1?this.monthAnchorCollection[t].className="Btn on":this.monthAnchorCollection[t].className="Btn"}},setupInfoArea:function(e){if(1==e){var t=document.createElement("div");t.className="fnBottom",this.wrapperObj.append(t);var s=document.createElement("a");t.appendChild(s),this.infoBtnObj=new Pudd.Element(s),s.className="todayBtn",s.setAttribute("href","javascript:;");var i=document.createElement("span");s.appendChild(i),i.textContent="오늘";var a=document.createElement("span");t.appendChild(a),a.className="infoText",a.textContent=this.dateObj.getFormatDateString(this.curDateObj);var o=document.createElement("div");if(o.className="fnBtn",t.appendChild(o),this.fnCallback_confirm&&"function"==typeof this.fnCallback_confirm){var n=document.createElement("a");n.className="botBtn",o.appendChild(n),new Pudd.Element(n).on("click",function(e){var t=this.selectionRule_getWeek(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate,0,this.optObject.selectionRule.startWeek),s=this.selectionRule_callBack_process(t);this.fnCallback_confirm.call(this,s)}.bind(this));var r=document.createElement("span");r.textContent="확인",n.appendChild(r)}if(this.fnCallback_cancel&&"function"==typeof this.fnCallback_cancel){var l=document.createElement("a");l.className="botBtn",o.appendChild(l),new Pudd.Element(l).on("click",function(e){this.fnCallback_cancel.call(this)}.bind(this));var h=document.createElement("span");h.textContent="취소",l.appendChild(h)}}},period_setupInfoArea:function(){var e=document.createElement("div");e.className="fnBottom",this.periodWrapObj.append(e);var t=document.createElement("span");e.appendChild(t),t.className="infoText",t.textContent="선택기간 : 0 일",this.periodInfoTextObj=new Pudd.Element(t);var s=document.createElement("div");s.className="fnBtn",e.appendChild(s);var i=document.createElement("a");i.className="botBtn",s.appendChild(i),new Pudd.Element(i).on("click",function(e){if(this.fnCallback_confirm&&"function"==typeof this.fnCallback_confirm){var t={startDate:"",endDate:""};if(this.period_fromYear){var s=new Date(this.period_fromYear,this.period_fromMonth-1,this.period_fromDate),i=new Pudd.Util.Date;t.startDate=i.getFormatDateString(s)}if(this.period_toYear){var a=new Date(this.period_toYear,this.period_toMonth-1,this.period_toDate);i=new Pudd.Util.Date;t.endDate=i.getFormatDateString(a)}this.fnCallback_confirm.call(this,t)}}.bind(this));var a=document.createElement("span");a.textContent="확인",i.appendChild(a);var o=document.createElement("a");o.className="botBtn",s.appendChild(o),new Pudd.Element(o).on("click",function(e){this.fnCallback_cancel&&"function"==typeof this.fnCallback_cancel&&this.fnCallback_cancel.call(this)}.bind(this));var n=document.createElement("span");n.textContent="취소",o.appendChild(n)},setupEvent:function(o){var n=this;this.selectDateObjArr.forEach(function(e,s){e.on("click",function(e){var t="fadeInRight";0!=s&&1!=s||(t="fadeInLeft"),1==o&&(n.calendarTableObj.addClass("animated05s"),n.calendarTableObj.addClass(t)),n.changeYearMonth(s,o),1==o&&window.setTimeout(function(){n.calendarTableObj.removeClass("animated05s"),n.calendarTableObj.removeClass(t)},400)})}),1==o?(this.getAnchorCollection(o),this.dateAnchorCollection.forEach(function(i,e){var a=Pudd.getInstance(i);a.on("click",function(e){if(this.optObject.periodSelect&&!this.fromCalendar){var t=this.getAnchorDate(a,!0),s=new Date(this.periodParentObj.period_fromYear,this.periodParentObj.period_fromMonth-1,this.periodParentObj.period_fromDate);if(1==Pudd.Util.Date.compareDate(s,t))return!1}n.switchAnchorClass(i,o)}.bind(this)),a.on("mouseenter",function(e){if(this.optObject.periodSelect&&!this.fromCalendar){var t=this.getAnchorDate(a,!0),s=new Date(this.periodParentObj.period_fromYear,this.periodParentObj.period_fromMonth-1,this.periodParentObj.period_fromDate);1==Pudd.Util.Date.compareDate(s,t)&&(a.node.style.cursor="not-allowed")}}.bind(this)),a.on("mouseout",function(e){this.optObject.periodSelect&&!this.fromCalendar&&(a.node.style.cursor="pointer")}.bind(this))}.bind(this)),this.infoBtnObj&&this.infoBtnObj.on("click",function(e){n.clickInfoButton(o)})):2==o&&(this.getAnchorCollection(o),this.monthAnchorCollection.forEach(function(e,t){Pudd.getInstance(e).on("click",function(e){n.switchAnchorClass(this,o)})}))},getAnchorCollection:function(e){1==e?this.dateAnchorCollection||(this.dateAnchorCollection=Pudd.querySelectAll(".calendarTable table td a",this.wrapperObj.node)):2==e&&(this.monthAnchorCollection||(this.monthAnchorCollection=Pudd.querySelectAll(".monthBtn div div a",this.wrapperObj.node)))},switchAnchorClass:function(e,t){if(1==t){var s=Pudd.getInstance(e);if(this.optObject.periodSelect)this.period_switchAnchorClass(s);else{var i=this.getAnchorDate(s,!1);if(this.userSelectedYear=i.year,this.userSelectedMonth=i.month,this.userSelectedDate=i.date,this.optObject.selectionRule){this.clearAnchorClass(this.wrapperObj.node),this.clearPeriodClass(this.wrapperObj.node);var a=this.selectionRule_getWeek(i.year,i.month-1,i.date,0,this.optObject.selectionRule.startWeek);this.selectionRule_selectAnchorClass(a),this.fnCallback&&"function"==typeof this.fnCallback&&this.selectionRule_callBack(a)}else if(this.clearAnchorClass(this.wrapperObj.node),s.addClass("selected"),this.fnCallback&&"function"==typeof this.fnCallback){var o=new Date(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate),n=this.dateObj.getFormatDateString(o);this.fnCallback.call(this,n)}}}else if(2==t){s=Pudd.getInstance(e);if(this.userSelectedYear=this.selectYear,this.userSelectedMonth=s.idx,this.selectMonth=s.idx,this.getAnchorCollection(t),this.monthAnchorCollection.forEach(function(e,t){Pudd.getInstance(e).removeClass("on")}),s.addClass("on"),this.fnCallback&&"function"==typeof this.fnCallback){o=new Date(this.userSelectedYear,this.userSelectedMonth-1,1);var r=this.dateObj.getFormatMonthString(o);this.fnCallback.call(this,r)}}},getAnchorDate:function(e,t){var s={year:null,month:null,date:null},i=this.dateObj.calendarMatrix[e.row][e.col];return 0==this.dateObj.calendarCurMatrix[e.row][e.col]?e.row<2?(1==this.selectMonth?(s.year=this.selectYear-1,s.month=12):(s.year=this.selectYear,s.month=this.selectMonth-1),s.date=i):4<=e.row&&(12==this.selectMonth?(s.year=this.selectYear+1,s.month=1):(s.year=this.selectYear,s.month=this.selectMonth+1),s.date=i):(s.year=this.selectYear,s.month=this.selectMonth,s.date=i),t&&(s=new Date(s.year,s.month-1,s.date)),s},clearAnchorClass:function(e){Pudd.querySelectAll(".calendarTable table td a.selected",e).forEach(function(e,t){Pudd.getInstance(e).removeClass("selected")})},clearPeriodClass:function(e){Pudd.querySelectAll(".calendarTable table td.period",e).forEach(function(e,t){Pudd.getInstance(e).removeClass("period")})},period_switchAnchorClass:function(e){if(this.wrapperObj.hasClass("fromDate")){var t=this.getAnchorDate(e,!1);this.periodParentObj.period_fromYear=t.year,this.periodParentObj.period_fromMonth=t.month,this.periodParentObj.period_fromDate=t.date}else{t=this.getAnchorDate(e,!1);this.periodParentObj.period_toYear=t.year,this.periodParentObj.period_toMonth=t.month,this.periodParentObj.period_toDate=t.date}this.period_switchAnchorClassProcess(this.periodParentObj)},period_switchAnchorClassProcess:function(e){if(this.clearAnchorClass(e.periodFromObj.wrapperObj.node),this.clearAnchorClass(e.periodToObj.wrapperObj.node),this.clearPeriodClass(e.periodFromObj.wrapperObj.node),this.clearPeriodClass(e.periodToObj.wrapperObj.node),e.optObject.selectionRule&&e.period_fromYear){var t=this.selectionRule_getWeek(e.period_fromYear,e.period_fromMonth-1,e.period_fromDate,0,e.optObject.selectionRule.startWeek);if(e.period_fromYear=t[0][0],e.period_fromMonth=t[0][1],e.period_fromDate=t[0][2],e.period_toYear){var s=new Date(e.period_fromYear,e.period_fromMonth-1,e.period_fromDate),i=new Date(e.period_toYear,e.period_toMonth-1,e.period_toDate);if(1!=Pudd.Util.Date.compareDate(s,i)){var a=this.selectionRule_getWeek(e.period_toYear,e.period_toMonth-1,e.period_toDate,0,e.optObject.selectionRule.startWeek),o=a.length-1;e.period_toYear=a[o][0],e.period_toMonth=a[o][1],e.period_toDate=a[o][2]}else{o=t.length-1;e.period_toYear=t[o][0],e.period_toMonth=t[o][1],e.period_toDate=t[o][2]}}else{o=t.length-1;e.period_toYear=t[o][0],e.period_toMonth=t[o][1],e.period_toDate=t[o][2]}}if(e.period_fromYear&&e.period_toYear){s=new Date(e.period_fromYear,e.period_fromMonth-1,e.period_fromDate),i=new Date(e.period_toYear,e.period_toMonth-1,e.period_toDate);if(1!=Pudd.Util.Date.compareDate(s,i)){var n=Pudd.Util.Date.dateDiff(s,i)+1;this.period_setInfoText(e,n)}else e.period_toYear=e.period_fromYear,e.period_toMonth=e.period_fromMonth,e.period_toDate=e.period_fromDate,this.period_setInfoText(e,"1")}else e.period_fromYear&&!e.period_toYear?(e.period_toYear=e.period_fromYear,e.period_toMonth=e.period_fromMonth,e.period_toDate=e.period_fromDate,this.period_setInfoText(e,"1")):!e.period_fromYear&&e.period_toYear?(e.period_fromYear=e.period_toYear,e.period_fromMonth=e.period_toMonth,e.period_fromDate=e.period_toDate,this.period_setInfoText(e,"1")):this.period_setInfoText(e,"0");this.selectAnchorClass(e,e.periodFromObj),this.selectAnchorClass(e,e.periodToObj)},period_setInfoText:function(e,t){if(e.optObject.selectionRule){var s=parseInt(t/7);e.periodInfoTextObj.text("선택기간 : "+s+" 주")}else e.periodInfoTextObj.text("선택기간 : "+t+" 일")},selectAnchorClass:function(e,t){if(e.period_fromYear&&e.period_toYear){if(e.period_fromYear){var s=new Date(e.period_toYear,e.period_toMonth-1,e.period_toDate);this.selectAnchorClassProcess(e.period_fromYear,e.period_fromMonth,e.period_fromDate,t,-1,s)}e.period_toYear&&this.selectAnchorClassProcess(e.period_toYear,e.period_toMonth,e.period_toDate,t,1,null)}else e.period_fromYear&&this.selectAnchorClassProcess(e.period_fromYear,e.period_fromMonth,e.period_fromDate,t,0,null),e.period_toYear&&this.selectAnchorClassProcess(e.period_toYear,e.period_toMonth,e.period_toDate,t,0,null)},selectAnchorClassProcess:function(e,t,s,i,a,o){for(var n=new Date(e,t-1,s),r=0;r<i.dateObj.calendarMatrix.length;r++)for(var l=0;l<i.dateObj.calendarMatrix[r].length;l++){var h=i.dateObj.calendarMatrix[r][l],d=null;0==i.dateObj.calendarCurMatrix[r][l]?r<2?d=1==i.selectMonth?new Date(i.selectYear-1,11,h):new Date(i.selectYear,i.selectMonth-2,h):4<=r&&(d=12==i.selectMonth?new Date(i.selectYear+1,0,h):new Date(i.selectYear,i.selectMonth,h)):d=new Date(i.selectYear,i.selectMonth-1,h);var c=r*i.weekName.length+l,p=Pudd.getInstance(i.dateAnchorCollection[c]),u=Pudd.Util.Date.compareDate(n,d);if(0==u)p.addClass("selected");else if(-1==u){if(-1==a)if(-1==Pudd.Util.Date.compareDate(d,o)){var f=p.parent();f&&f.addClass("period")}}}},clickInfoButton:function(e){var t=this.curDateObj.getFullYear(),s=this.curDateObj.getMonth()+1,i=this.curDateObj.getDate();this.userSelectedYear=t,this.userSelectedMonth=s,this.userSelectedDate=i,t==this.selectYear&&s==this.selectMonth?this.mappingCalendarArea_date(this.calendarTableObj.node,e):(this.calendarTableObj.addClass("animated05s"),this.calendarTableObj.addClass("fadeInRight"),this.dateObj.reset(t,s,1),this.initDate(e),this.dateTextObj.text(this.dateObj.getYearString()+"."+this.dateObj.getMonthString()),this.mappingCalendarArea_date(this.calendarTableObj.node,e),window.setTimeout(function(){this.calendarTableObj.removeClass("animated05s"),this.calendarTableObj.removeClass("fadeInRight")}.bind(this),500));var a=null;if(1==e&&this.optObject.selectionRule&&(this.clearAnchorClass(this.wrapperObj.node),this.clearPeriodClass(this.wrapperObj.node),a=this.selectionRule_getWeek(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate,0,this.optObject.selectionRule.startWeek),this.selectionRule_selectAnchorClass(a)),this.fnCallback&&"function"==typeof this.fnCallback)if(1==e&&this.optObject.selectionRule)this.selectionRule_callBack(a);else{var o=new Date(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate),n=this.dateObj.getFormatDateString(o);this.fnCallback.call(this,n)}},changeYearMonth:function(e,t){if(1==t){if(0==e?this.dateObj.reset(this.selectYear-1,this.selectMonth,1):1==e?1==this.selectMonth?this.dateObj.reset(this.selectYear-1,12,1):this.dateObj.reset(this.selectYear,this.selectMonth-1,1):2==e?12==this.selectMonth?this.dateObj.reset(this.selectYear+1,1,1):this.dateObj.reset(this.selectYear,this.selectMonth+1,1):3==e&&this.dateObj.reset(this.selectYear+1,this.selectMonth,1),this.initDate(t),this.dateTextObj.text(this.dateObj.getYearString()+"."+this.dateObj.getMonthString()),this.mappingCalendarArea_date(this.calendarTableObj.node,t),this.periodParentObj)this.selectAnchorClass(this.periodParentObj,this);else if(this.optObject.selectionRule){this.clearAnchorClass(this.wrapperObj.node),this.clearPeriodClass(this.wrapperObj.node);var s=this.selectionRule_getWeek(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate,0,this.optObject.selectionRule.startWeek);this.selectionRule_selectAnchorClass(s)}}else if(2==t){if(0==e)return;if(1==e)this.dateObj.reset(this.selectYear-1,this.selectMonth,1);else if(2==e)this.dateObj.reset(this.selectYear+1,this.selectMonth,1);else if(3==e)return;this.initDate(t),this.dateTextObj.text(this.dateObj.getYearString()),this.mappingCalendarArea_month(t)}},registerCallback:function(e){this.fnCallback=e},registerPeriodCallback:function(e,t){this.fnCallback_confirm=e,this.fnCallback_cancel=t},assignNewValue:function(e){this.initDate(this.optObject.displayType,e),1==this.optObject.displayType?(this.dateTextObj.text(this.dateObj.getYearString()+"."+this.dateObj.getMonthString()),this.mappingCalendarArea_date(this.calendarTableObj.node,this.optObject.displayType),this.optObject.selectionRule&&(this.clearAnchorClass(this.wrapperObj.node),this.clearPeriodClass(this.wrapperObj.node),week=this.selectionRule_getWeek(this.userSelectedYear,this.userSelectedMonth-1,this.userSelectedDate,0,this.optObject.selectionRule.startWeek),this.selectionRule_selectAnchorClass(week))):2==this.optObject.displayType&&(this.dateTextObj.text(this.dateObj.getYearString()),this.mappingCalendarArea_month(this.optObject.displayType))},period_assignNewValue:function(e,t){var s=e.split("-"),i=t.split("-");3==s.length?(s[0]=parseInt(s[0],10),s[1]=parseInt(s[1],10),s[2]=parseInt(s[2],10)):(s[0]=null,s[1]=null,s[2]=null),3==i.length?(i[0]=parseInt(i[0],10),i[1]=parseInt(i[1],10),i[2]=parseInt(i[2],10)):(i[0]=null,i[1]=null,i[2]=null),this.period_selection_process(e,t,s[0],s[1],s[2],i[0],i[1],i[2])},eventKeydown:function(e){var t=this.optObject.displayType;if(!this.keyPos)if(1==t){if(1==(i=Pudd.querySelectAll(".calendarTable table td a.selected",this.wrapperObj.node)).length&&(this.newKeyPos(!0),aObj=Pudd.getInstance(i[0]),this.keyPos.row=aObj.row+1,this.keyPos.col=aObj.col),!this.keyPos&&1==(i=Pudd.querySelectAll(".calendarTable table td.today",this.wrapperObj.node)).length){this.newKeyPos(!0);var s=(a=i[0]).parentNode;this.keyPos.row=s.rowIndex,this.keyPos.col=a.cellIndex}}else if(2==t){var i;1==(i=Pudd.querySelectAll(".monthBtn div div a.on",this.node)).length&&(this.newKeyPos(!0),aObj=Pudd.getInstance(i[0]),this.keyPos.idxMonth=aObj.idx-1)}if(this.keyPos)if(1==t){if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_LEFT)-1!=this.keyPos.yearMonth?0!=this.keyPos.yearMonth&&(this.setKeyPosMarkStyle(!1),this.keyPos.yearMonth--,this.setKeyPosMarkStyle(!0)):-1!=this.keyPos.row&&-1!=this.keyPos.col&&(0==this.keyPos.col?this.changeYearMonth(1,t):(this.setKeyPosMarkStyle(!1),this.keyPos.col--),this.setKeyPosMarkStyle(!0));else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_TOP)-1!=this.keyPos.row&&-1!=this.keyPos.col?(1==this.keyPos.row?(this.setKeyPosMarkStyle(!1),0==this.keyPos.col?this.keyPos.yearMonth=0:1==this.keyPos.col||2==this.keyPos.col?this.keyPos.yearMonth=1:3==this.keyPos.col||4==this.keyPos.col||5==this.keyPos.col?this.keyPos.yearMonth=2:this.keyPos.yearMonth=3,this.keyPos.row=-1,this.keyPos.col=-1):(this.setKeyPosMarkStyle(!1),this.keyPos.row--),this.setKeyPosMarkStyle(!0)):this.keyPos.info&&(this.setKeyPosMarkStyle(!1),this.keyPos.row=6,this.keyPos.col=0,this.keyPos.info=!1,this.setKeyPosMarkStyle(!0));else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT)-1!=this.keyPos.yearMonth?this.keyPos.yearMonth<this.selectDateObjArr.length-1&&(this.setKeyPosMarkStyle(!1),this.keyPos.yearMonth++,this.setKeyPosMarkStyle(!0)):-1!=this.keyPos.row&&-1!=this.keyPos.col&&(this.keyPos.col==this.weekName.length-1?this.changeYearMonth(2,t):(this.setKeyPosMarkStyle(!1),this.keyPos.col++),this.setKeyPosMarkStyle(!0));else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM)-1!=this.keyPos.yearMonth?(this.setKeyPosMarkStyle(!1),0==this.keyPos.yearMonth?this.keyPos.col=0:1==this.keyPos.yearMonth?this.keyPos.col=1:2==this.keyPos.yearMonth?this.keyPos.col=5:this.keyPos.col=6,this.keyPos.row=1,this.keyPos.yearMonth=-1,this.setKeyPosMarkStyle(!0)):-1!=this.keyPos.row&&-1!=this.keyPos.col&&(this.keyPos.row==this.weekCnt?(this.setKeyPosMarkStyle(!1),this.keyPos.row=-1,this.keyPos.col=-1,this.keyPos.info=!0):(this.setKeyPosMarkStyle(!1),this.keyPos.row++),this.setKeyPosMarkStyle(!0));else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ENTER)if(-1!=this.keyPos.yearMonth)this.changeYearMonth(this.keyPos.yearMonth,t);else if(-1!=this.keyPos.row&&-1!=this.keyPos.col){var a=(s=this.calendarTableObj.node.rows[this.keyPos.row]).cells[this.keyPos.col],o=Pudd.getInstance(a);this.switchAnchorClass(o.aObj.node,t)}else this.keyPos.info&&this.clickInfoButton(t)}else if(2==t)if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_LEFT){if(-1!=this.keyPos.yearMonth)2==this.keyPos.yearMonth&&(this.setKeyPosMarkStyle(!1),this.keyPos.yearMonth=1,this.setKeyPosMarkStyle(!0));else if(-1!=this.keyPos.idxMonth){0==(n=this.keyPos.idxMonth%this.groupColCnt)?this.changeYearMonth(1,t):(this.setKeyPosMarkStyle(!1),this.keyPos.idxMonth--,this.setKeyPosMarkStyle(!0))}}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_TOP){if(-1!=this.keyPos.idxMonth)if(0==parseInt(this.keyPos.idxMonth/this.groupColCnt,10)){this.setKeyPosMarkStyle(!1);var n=this.keyPos.idxMonth%this.groupColCnt;this.keyPos.yearMonth=0==n||1==n?1:2,this.keyPos.idxMonth=-1,this.setKeyPosMarkStyle(!0)}else this.setKeyPosMarkStyle(!1),this.keyPos.idxMonth-=this.groupColCnt,this.setKeyPosMarkStyle(!0)}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT){if(-1!=this.keyPos.yearMonth)1==this.keyPos.yearMonth&&(this.setKeyPosMarkStyle(!1),this.keyPos.yearMonth=2,this.setKeyPosMarkStyle(!0));else if(-1!=this.keyPos.idxMonth){(n=this.keyPos.idxMonth%this.groupColCnt)==this.groupColCnt-1?this.changeYearMonth(2,t):(this.setKeyPosMarkStyle(!1),this.keyPos.idxMonth++,this.setKeyPosMarkStyle(!0))}}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM){if(-1!=this.keyPos.yearMonth){if(this.setKeyPosMarkStyle(!1),1==this.keyPos.yearMonth)this.keyPos.idxMonth=0;else{if(2!=this.keyPos.yearMonth)return;this.keyPos.idxMonth=3}this.keyPos.yearMonth=-1,this.setKeyPosMarkStyle(!0)}else if(-1!=this.keyPos.idxMonth){parseInt(this.keyPos.idxMonth/this.groupColCnt,10)==this.groupRowCnt-1||(this.setKeyPosMarkStyle(!1),this.keyPos.idxMonth+=this.groupColCnt,this.setKeyPosMarkStyle(!0))}}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ENTER)if(-1!=this.keyPos.yearMonth)1!=this.keyPos.yearMonth&&2!=this.keyPos.yearMonth||this.changeYearMonth(this.keyPos.yearMonth,t);else if(-1!=this.keyPos.idxMonth){var r=this.monthAnchorCollection[this.keyPos.idxMonth];this.switchAnchorClass(r,t)}},newKeyPos:function(e){e?(this.keyPos={},this.keyPos.yearMonth=-1,this.keyPos.row=-1,this.keyPos.col=-1,this.keyPos.info=!1,this.keyPos.idxMonth=-1):this.keyPos=null},setKeyPosMarkStyle:function(e){if(this.keyPos)if(1==this.optObject.displayType){if(-1!=this.keyPos.yearMonth){if(!this.selectDateObjArr)return;if(this.keyPos.yearMonth>=this.selectDateObjArr.length)return;var t=this.selectDateObjArr[this.keyPos.yearMonth];e?t.style("border","1px solid #cccccc"):t.style("border",null)}else if(-1!=this.keyPos.row&&-1!=this.keyPos.col){var s=this.calendarTableObj.node.rows[this.keyPos.row].cells[this.keyPos.col],i=Pudd.getInstance(s);e?i.aObj.addClass("focused"):i.aObj.removeClass("focused")}else if(this.keyPos.info){if(!this.infoBtnObj)return;e?this.infoBtnObj.style("border","1px solid #8c8c8c"):this.infoBtnObj.style("border",null)}}else if(2==this.optObject.displayType)if(-1!=this.keyPos.yearMonth){if(!this.selectDateObjArr)return;if(this.keyPos.yearMonth>=this.selectDateObjArr.length)return;t=this.selectDateObjArr[this.keyPos.yearMonth];e?t.style("border","1px solid #cccccc"):t.style("border",null)}else if(-1!=this.keyPos.idxMonth){if(!this.monthAnchorCollection)return;if(this.keyPos.idxMonth>=this.monthAnchorCollection.length)return;var a=this.monthAnchorCollection[this.keyPos.idxMonth],o=Pudd.getInstance(a);e?o.style("border","1px solid #1c90fb"):o.style("border",null)}},selectionRule_getWeek:function(e,t,s,i,a){for(var o=new Date(e,t,s).getDay(),n=[],r=0;r<7;r++){var l=new Date(e,t,s+(r-o+i+a)),h=l.getFullYear(),d=Number(l.getMonth())+1,c=l.getDate();n[r]=[],n[r][0]=h,n[r][1]=d,n[r][2]=c}return n},selectionRule_selectAnchorClass:function(e){if(e&&0!=e.length){var t=e.length-1,s=new Date(e[t][0],e[t][1]-1,e[t][2]);this.selectionRule_selectAnchorClassProcess(e[0][0],e[0][1],e[0][2],this,-1,s)}},selectionRule_selectAnchorClassProcess:function(e,t,s,i,a,o){for(var n=new Date(e,t-1,s),r=0;r<i.dateObj.calendarMatrix.length;r++)for(var l=0;l<i.dateObj.calendarMatrix[r].length;l++){var h=i.dateObj.calendarMatrix[r][l],d=null;0==i.dateObj.calendarCurMatrix[r][l]?r<2?d=1==this.selectMonth?new Date(i.selectYear-1,11,h):new Date(i.selectYear,i.selectMonth-2,h):4<=r&&(d=12==this.selectMonth?new Date(i.selectYear+1,0,h):new Date(i.selectYear,i.selectMonth,h)):d=new Date(i.selectYear,i.selectMonth-1,h);var c=r*i.weekName.length+l,p=Pudd.getInstance(i.dateAnchorCollection[c]),u=Pudd.Util.Date.compareDate(n,d);if(0==u)p.addClass("selected");else if(-1==u&&-1==a){var f=Pudd.Util.Date.compareDate(d,o);if(-1==f){var b=p.parent();b&&b.addClass("period")}else 0==f&&p.addClass("selected")}}},selectionRule_callBack:function(e){var t=this.selectionRule_callBack_process(e);this.fnCallback.call(this,t)},selectionRule_callBack_process:function(e){var t={startDate:"",endDate:""},s=new Pudd.Util.Date,i=new Date(e[0][0],e[0][1]-1,e[0][2]);t.startDate=s.getFormatDateString(i);var a=e.length-1,o=new Date(e[a][0],e[a][1]-1,e[a][2]);return t.endDate=s.getFormatDateString(o),t}}});
Pudd.Element.Component.GridTable=Pudd.invent({init:function(e){this.rightAreaTdObj=null,this.gridWrapDivObj=null,this.headerDivObj=null,this.contentDivObj=null,this.footerDivObj=null,this.headerTableObj=null,this.contentTableObj=null,this.contentTableTbodyObj=null,this.footerTableObj=null,this.pagerObj=null,this.lastCellObj=null,this.editRecObj=null,this.editRecChildObj=null,this.editRecChildSubObj=null,this.editControls=null,this.checkControls=null,this.changeComboBox=!1,this.changeDatePicker=!1,this.eventKeydownSet=!1,this.progressBarObj=null,this.storage=null,this.agentType=null,this.constructor.call(this,e)},inherit:Pudd.Element.Component,extend:{setup:function(e){if(this.agentType=Pudd.Fn.getUserAgentType(),this.setupContainer(),this.optObject=this.parseOption(e),this.optObject.attributes){var t=this.optObject.attributes;for(var n in t){var i=n.toLowerCase().trim();"style"==i?this.style(t[n]):"class"==i?this.addClass(t[n]):this.attr(n,t[n])}}if(this.storage||(this.storage=new Pudd.Util.Storage),this.optObject.hoverUse||this.addClass("hover_no"),null!=e){if(this.node.innerHTML="",this.setupGarbageAnchor(),e.editable)this.editControls={},this.addClass(Pudd.Config.className.PUDD_UI_editTable),this.setupContainerTable(this.optObject);else{this.addClass(Pudd.Config.className.PUDD_UI_GridTable);var o=document.createElement("div");this.gridWrapDivObj=new Pudd.Element(o),this.gridWrapDivObj.addClass("grid-wrap"),this.append(this.gridWrapDivObj)}if(this.setupHeaderTable(this.optObject),e.editable?(this.setupHeader(this.optObject),this.headerDivObj&&this.rightAreaTdObj.append(this.headerDivObj)):(this.setupHeader(this.optObject),this.headerDivObj&&this.gridWrapDivObj.append(this.headerDivObj)),this.optObject.progressBar){if(!this.progressBarObj){o=document.createElement("div");this.append(o),this.progressBarObj=new Pudd.Element.Component.ProgressBar(o),this.progressBarObj.setup(this.optObject.progressBar)}var l=document.createElement("div");l.style.height=null==this.optObject.height?"100px":this.optObject.height+"px",this.append(l),setTimeout(function(){l&&l.parentNode&&(this.setup_process(),this.node.removeChild(l)),this.progressBarObj.clearIntervalSet()}.bind(this),10)}else this.setup_process()}return this},setup_process:function(){this.setupDataContentGrid(this.optObject),this.setupEvent(),this.columnDisplayCopy(),this.loadResizeRemember(),this.remove_resize_setupEvent(),this.resize_setupEvent(),this.hideColumnSetup(),this.sinkScroll(),this.adjustTableScroll()},parseOption:function(e){return e?(e.scrollable=!0===e.scrollable,e.height=this.getPositiveNumber(e.height,null),e.sortable=!0===e.sortable,e.sortPageSame="boolean"!=typeof e.sortPageSame||e.sortPageSame,e.ellipsis=!0===e.ellipsis,e.hoverUse="boolean"!=typeof e.hoverUse||e.hoverUse,e.hoverUse?e.hoverClick="boolean"!=typeof e.hoverClick||e.hoverClick:e.hoverClick=!1,e.resizable=!0===e.resizable,e.resizeRemember=!0===e.resizeRemember,e.resizeRememberName="string"==typeof e.resizeRememberName?e.resizeRememberName:null,e.editable=!0===e.editable,e.loadCallback="function"==typeof e.loadCallback?e.loadCallback:function(){},e.progressBar="object"==typeof e.progressBar?e.progressBar:null,e.clickCancelAtTextSelection="boolean"==typeof e.clickCancelAtTextSelection&&e.clickCancelAtTextSelection):e={scrollable:!1,height:null,sortable:!1,sortPageSame:!0,ellipsis:!1,hoverUse:!0,hoverClick:!0,resizable:!1,resizeRemember:!1,resizeRememberName:null,editable:!1,loadCallback:function(){},progressBar:null,clickCancelAtTextSelection:!1},e},setupGarbageAnchor:function(){var e=document.createElement("a");e.setAttribute("href","javascript:;");var t=Pudd.getInstance(e);t.style("position:absolute;top:-2px;width:0px;height:0px;"),this.append(t),t.on("focusin",function(e){if(this.optObject.editable&&!(this.contentTableObj.node.rows.length<=0||this.contentTableObj.node.rows[0].cells.length<=0)){var t=this.contentTableObj.node.rows[0].cells[0],n=Pudd.getInstance(t);this.appendEditRecDiv(n,!0)}}.bind(this))},setupCommonColGroup:function(e,t){for(var n=document.createElement("colgroup"),i=0;i<e.columns.length;i++){var o=e.columns[i];this.setupCommonColGroupProcess(n,o,t)}return n},setupCommonColGroupProcess:function(e,t,n){var i=document.createElement("col");if(t.columns)for(var o=0;o<t.columns.length;o++){var l=t.columns[o];this.setupCommonColGroupProcess(e,l,n)}else t.width&&(void 0===t.widthUnit?i.style.width=t.width+"px":""==t.widthUnit?i.style.width=t.width+"px":i.style.width=t.width+t.widthUnit),e.appendChild(i),n&&(Pudd.getInstance(i).column=t)},setupCustomProperty:function(e,t,n,i){if(e){if("function"==typeof e.template){var o="";n?o=e.template.call(this,n):i&&(o=e.template.call(this)),t.innerHTML=o}var l=e.attributes;if(l){var s=Pudd.getInstance(t);for(var r in l)"style"==r?s.style(l[r]):s.attr(r,l[r])}}},setupCustomToolTipProperty:function(e,t,n,i){if(e){var o=n;"function"==typeof e.template&&i&&(o=e.template.call(this,i));var l=Pudd.getInstance(t);l.tooltip={},l.tooltip.alwaysShow="boolean"==typeof e.alwaysShow&&e.alwaysShow,l.tooltip.showAtClientX="boolean"==typeof e.showAtClientX&&e.showAtClientX,l.tooltip.toolTipMsg=o,l.tooltip.toolTipUtil=new Pudd.Util.ToolTip,l.tooltip.toolTipUtil.initToolTip(l,o),l.tooltip.toolTipUtil.setPropAlwaysShow(l.tooltip.alwaysShow),l.tooltip.toolTipUtil.setPropShowAtClientX(l.tooltip.showAtClientX),e.attributes&&this.setupAttributes(l.tooltip.toolTipUtil.toolTipObj,e.attributes)}},setupContainerTable:function(e){var t=document.createElement("table"),n=document.createElement("tr");t.appendChild(n);var i=document.createElement("td");n.appendChild(i),this.rightAreaTdObj=new Pudd.Element(i),this.rightAreaTdObj.addClass("rightArea"),this.append(t)},setupHeaderTable:function(e){var t=document.createElement("table");this.headerTableObj=new Pudd.Element(t);var n=this.setupCommonColGroup(e,!0);n&&this.headerTableObj.append(n);var i=this.setupHeaderTable_thead(e);i&&this.headerTableObj.append(i),e.editable&&this.headerTableObj.addClass("editTable")},setupHeaderTable_thead:function(e){var t={row:-1,col:-1,rowCnt:0};this.scanColumnStructure(e.columns,t);this.calculateColumnStructure(e.columns,t.rowCnt,{idxOrder:0,idxCol:0});var n=document.createElement("thead");return this.setupHeaderTable_thead_process(n,e.columns),n},scanColumnStructure:function(e,t){var n=0;t.row++,t.row+1>t.rowCnt&&(t.rowCnt=t.row+1);for(var i=0;i<e.length;i++){t.col++;var o=e[i];n+=this.doScanColumnStructure(o,t)}return t.row--,n},doScanColumnStructure:function(e,t){var n=1;return e.row=t.row,e.col=t.col,e.columns&&0<e.columns.length&&(t.col--,n=this.scanColumnStructure(e.columns,t)),e.colSpan=n},calculateColumnStructure:function(e,t,n){for(var i=0;i<e.length;i++){var o=e[i];o.idxOrder=n.idxOrder,n.idxOrder++,this.doCalculateColumnStructure(e,o,t,n)}},doCalculateColumnStructure:function(e,t,n,i){t.columns&&0<t.columns.length?(t.rowSpan=1,t.idxStartCol=i.idxCol,this.calculateColumnStructure(t.columns,n,i),t.idxEndCol=i.idxCol-1):(t.rowSpan=n-t.row,t.idxCol=i.idxCol,i.idxCol++)},setupHeaderTable_thead_process:function(e,t){for(var n=0;n<t.length;n++){var i=t[n];this.doSetupHeaderTable_thead_process(e,i)}},doSetupHeaderTable_thead_process:function(e,t){var n=this.getHeaderTable_thead_row(e,t.row),i=document.createElement("th");n.appendChild(i),i.rowSpan=t.rowSpan,i.colSpan=t.colSpan;var o=Pudd.getInstance(i);o.idxOrder=t.idxOrder,void 0===t.idxCol?(o.idxStartCol=t.idxStartCol,o.idxEndCol=t.idxEndCol):o.idxCol=t.idxCol,o.column=t,this.setupHeaderTable_thead_detail(i,t),t.columns&&0<t.columns.length&&this.setupHeaderTable_thead_process(e,t.columns)},getHeaderTable_thead_row:function(e,t){var n=Pudd.querySelectAll("tr",e);if(n.length<=t){var i=document.createElement("tr");return e.appendChild(i),i}return n[t]},setupHeaderTable_thead_detail:function(e,i){var l=this,t=!1;if(i.editControl&&Pudd.Config.const.ID_CHECKBOX==this.getEditTypeCode(i.editControl.type)){this.checkControls||(this.checkControls={});var n=this.createCheckBox(i);n.field=i.field,e.appendChild(n.containerObj.node),this.checkControls[i.field]||(this.checkControls[i.field]={}),this.checkControls[i.field].header=n,i.editControl.header&&"function"==typeof i.editControl.header.initControl&&i.editControl.header.initControl.call(this,n),"boolean"==typeof i.editControl.basicUse&&i.editControl.basicUse&&n.on("click",function(e){var t=Pudd.getInstance(this),n=!!t.attr("checked");if(l.agentType.ie&&(n=!n),l.checkControls[t.field]){var i=l.checkControls[t.field].content;if(i)for(var o=0;o<i.length;o++){!!i[o].attr("disabled")||i[o].setChecked(n)}}}),t=!0}if(t||(i.title&&(e.textContent=i.title),this.setupCustomProperty(i.header,e,null,!0)),!t){var o=!1,s=!0;if(this.optObject.sortable?"boolean"==typeof i.sortable?i.sortable&&(o=!0):o=!0:"boolean"==typeof i.sortable&&i.sortable&&(o=!0),o&&"boolean"==typeof i.sortableDisplay&&(s=i.sortableDisplay),o){e.style.cursor="pointer";var r=document.createElement("span");e.appendChild(r);var d=new Pudd.Element(r);d.addClass("p-icon"),d.hide(),"asc"==i.sortSelected?(d.addClass("p-i-arrow-n"),s&&d.style("display:inline-block;")):"desc"==i.sortSelected&&(d.addClass("p-i-arrow-s"),s&&d.style("display:inline-block;")),(a=Pudd.getInstance(e)).spanObj=d,a.sortable=!0,a.sortableDisplay=s,a.on("click",function(e){if(l.node.parentNode){var t=1;if(l.optObject.sortPageSame&&(t=l.optObject.dataSource.page),a.spanObj.hasClass("p-i-arrow-n")||a.spanObj.hasClass("p-i-arrow-s"))a.spanObj.hasClass("p-i-arrow-n")?(a.spanObj.removeClass("p-i-arrow-n"),a.spanObj.addClass("p-i-arrow-s"),a.sortableDisplay?a.spanObj.style("display:inline-block;"):a.spanObj.hide(),l.optObject.dataSource.sortField=i.field,l.optObject.dataSource.sortType="desc",l.refreshGrid(t,l.optObject.dataSource.pageSize,i.field,"desc")):(a.spanObj.hasClass("p-i-arrow-s"),a.spanObj.removeClass("p-i-arrow-s"),a.spanObj.addClass("p-i-arrow-n"),a.sortableDisplay?a.spanObj.style("display:inline-block;"):a.spanObj.hide(),l.optObject.dataSource.sortField=i.field,l.optObject.dataSource.sortType="asc",l.refreshGrid(t,l.optObject.dataSource.pageSize,i.field,"asc"));else Pudd.querySelectAll("span.p-icon",l.headerTableObj.node).forEach(function(e,t){var n=Pudd.getInstance(e);n.removeClass("p-i-arrow-n"),n.removeClass("p-i-arrow-s"),n.hide()}),a.spanObj.addClass("p-i-arrow-n"),a.sortableDisplay?a.spanObj.style("display:inline-block;"):a.spanObj.hide(),l.optObject.dataSource.sortField=i.field,l.optObject.dataSource.sortType="asc",l.refreshGrid(t,l.optObject.dataSource.pageSize,i.field,"asc");if(i&&i.header&&"function"==typeof i.header.clickCallback){var n=a.parent();i.header.clickCallback.call(l,a.node,n.node,l)}}})}else{var a;(a=Pudd.getInstance(e)).sortable=!1,a.on("click",function(e){if(l.node.parentNode&&i&&i.header&&"function"==typeof i.header.clickCallback){var t=a.parent();i.header.clickCallback.call(l,a.node,t.node,l)}})}}},setupHeader:function(e){if(this.headerTableObj){var t=document.createElement("div");this.headerDivObj=new Pudd.Element(t),e.editable?this.headerDivObj.addClass("rightHeader"):this.headerDivObj.addClass("grid-header"),this.headerDivObj.append(this.headerTableObj)}},setupContentTable:function(e,t){var n=document.createElement("table");this.contentTableObj=new Pudd.Element(n),e.editable&&this.contentTableObj.addClass("editTable");var i=this.setupCommonColGroup(e,!1);i&&this.contentTableObj.append(i);var o=this.setupContentTable_tbody(e,t);o&&this.contentTableObj.append(o)},setupContentTable_tbody:function(e,t){var n=document.createElement("tbody");if(this.contentTableTbodyObj=new Pudd.Element(n),!t)return n;for(var i=0;i<t.length;i++){var o=t[i],l=this.setupContentTable_tbody_tr(e,o);n.appendChild(l)}if(e.emptyRowDisplay){var s=t.length,r=e.dataSource.pageSize;if(r&&s<r)for(i=s;i<r;i++)this.addRow(null,i)}return n},setupContentTable_tbody_tr:function(e,t){var n=document.createElement("tr");Pudd.getInstance(n).rowData=t;for(var i=0;i<e.columns.length;i++){var o=e.columns[i];this.setupContentTable_tbody_tr_process(n,o,t)}return n},setupContentTable_tbody_tr_process:function(e,t,n){if(t.columns)for(var i=0;i<t.columns.length;i++){var o=t.columns[i];this.setupContentTable_tbody_tr_process(e,o,n)}else{var l=document.createElement("td");e.appendChild(l);var s=Pudd.getInstance(l);s.column=t,this.setupContentTable_tbody_tr_detail(s,t,n)}},setupContentTable_tbody_tr_detail:function(e,t,n){var i=e.node,o=!1;if(t.editControl&&Pudd.Config.const.ID_CHECKBOX==this.getEditTypeCode(t.editControl.type)){if(n){var l=this.createCheckBox(t);if(l.field=t.field,t.editControl.dataValueField&&void 0!==n[t.editControl.dataValueField]){var s=n[t.editControl.dataValueField];l.val(s)}if(i.appendChild(l.containerObj.node),this.checkControls[t.field].content||(this.checkControls[t.field].content=[]),this.checkControls[t.field].content.push(l),(e.checkboxObj=l).tdObj=e,t.editControl.content&&"function"==typeof t.editControl.content.initControl&&t.editControl.content.initControl.call(this,l,n),"boolean"==typeof t.editControl.basicUse&&t.editControl.basicUse){var r=this;l.on("click",function(e){var t=Pudd.getInstance(this);t.self=!0;var n=!!t.attr("checked");if(r.agentType.ie&&(n=!n),r.checkControls[t.field]){var i=r.checkControls[t.field].content;if(i){for(var o=!1,l=0;l<i.length;l++){var s=i[l];if(!s.self)if(n!=!!s.attr("checked")){o=!0;break}}o?r.checkControls[t.field].header.setChecked(!1):n?r.checkControls[t.field].header.setChecked(!0):r.checkControls[t.field].header.setChecked(!1)}}t.self=null})}}o=!0}if(!o){var d="";n&&void 0!==n[t.field]&&(i.textContent=n[t.field],d=n[t.field]),this.setupCustomProperty(t.content,i,n,!1),this.setupCustomToolTipProperty(t.tooltip,i,d,n)}if(!o){var a=!1;this.optObject.ellipsis?"boolean"==typeof t.ellipsis?t.ellipsis&&(a=!0):a=!0:"boolean"==typeof t.ellipsis&&t.ellipsis&&(a=!0),a&&e.addClass("ellipsis")}},setupContent:function(e){if(this.contentTableObj){var t=document.createElement("div");this.contentDivObj=new Pudd.Element(t),e.editable?(this.contentDivObj.addClass("rightContent"),e&&e.scrollable&&e.height&&(this.contentDivObj.style("height",e.height+"px"),this.contentDivObj.style("overflow-x:auto;"))):(this.contentDivObj.addClass("grid-content"),e.scrollable||(e.height?this.contentDivObj.style("overflow:auto;"):this.contentDivObj.style("overflow-y:hidden;")),e.contentStyle&&this.contentDivObj.style(e.contentStyle),e&&e.scrollable&&(this.addClass(Pudd.Config.className.scrollable),e.height&&this.contentDivObj.style("height",e.height+"px"))),this.contentDivObj.append(this.contentTableObj)}},setupFooter:function(){if(this.footerTableObj){var e=document.createElement("div");this.append(e),this.footerDivObj=new Pudd.Element(e),this.footerDivObj.addClass("grid-footer"),this.footerDivObj.append(this.footerTableObj)}},setupDataContentGrid:function(e){var t=this.getDataPage(e);if((this.setupContentTable(e,t),this.setupContent(e),e.editable?this.contentDivObj&&this.rightAreaTdObj.append(this.contentDivObj):this.contentDivObj&&this.gridWrapDivObj.append(this.contentDivObj),this.setupPager(e),Pudd.initControlByNode(this.node),e.noDataMessage)&&((e.noDataMessage.message||e.noDataMessage.template)&&0==this.getGridDataCount())){var n=this.gridColCount();if(0!=n){var i=new Pudd.Element("tr"),o=new Pudd.Element("td");if(o.attr("colspan",n),"function"==typeof e.noDataMessage.template){var l=e.noDataMessage.template.call(this);o.node.innerHTML=l}else o.text(e.noDataMessage.message);i.append(o),this.contentTableTbodyObj.append(i)}}this.loadCallback(e)},loadCallback:function(e){if("function"==typeof e.loadCallback){var t=this.headerTableObj?this.headerTableObj.node:null,n=this.contentTableObj?this.contentTableObj.node:null,i=this.footerTableObj?this.footerTableObj.node:null;e.loadCallback.call(this,t,n,i,this)}},setupPager:function(e){if(e.pageable){this.addClass("pager_on");var t=document.createElement("div");if(this.append(t),!e.dataSource||(e.pageable.page=e.dataSource.page,e.pageable.totalCount=e.dataSource.totalCount,e.pageable.pageSize=e.dataSource.pageSize,0!=e.dataSource.totalCount)){this.pagerObj=new Pudd.Element.Component.Pager(t),this.pagerObj.setup(e.pageable);var o=this;this.pagerObj.on("pagerClick",function(e){var t=e.detail,n=o.optObject.dataSource.sortField,i=o.optObject.dataSource.sortType;return t.first?void o.refreshGrid(1,t.pageSize,n,i):t.prev?void(1<t.page&&o.refreshGrid(t.page-1,t.pageSize,n,i)):t.next?void(t.page+1<=t.lastPage&&o.refreshGrid(t.page+1,t.pageSize,n,i)):t.last?void o.refreshGrid(t.lastPage,t.pageSize,n,i):null!=t.page?void o.refreshGrid(t.page,t.pageSize,n,i):void o.refreshGrid(1,t.pageSize,n,i)})}}},refreshGrid:function(e,t,n,i,o){this.optObject.dataSource&&(this.optObject.dataSource.page=e,this.optObject.dataSource.pageSize=t,this.optObject.dataSource.sortField=void 0===n?"":n,this.optObject.dataSource.sortType=void 0===i?"":i,"function"==typeof o?this.optObject.progressBar?(this.progressBarObj.showProgressBar(),setTimeout(function(){this.refreshGrid_process(),this.progressBarObj.clearIntervalSet(),o.call(this)}.bind(this),100)):(this.refreshGrid_process(),o.call(this)):this.optObject.progressBar&&(o="boolean"!=typeof o||o)?(this.progressBarObj.showProgressBar(),setTimeout(function(){this.refreshGrid_process(),this.progressBarObj.clearIntervalSet()}.bind(this),100)):this.refreshGrid_process())},refreshGrid_process:function(){if(this.checkControls)for(var e in this.checkControls)this.checkControls[e].header.setChecked(!1);this.contentDivObj.node.removeChild(this.contentTableObj.node),this.contentTableObj=null,this.optObject.editable?this.rightAreaTdObj.node.removeChild(this.contentDivObj.node):this.gridWrapDivObj.node.removeChild(this.contentDivObj.node),this.headerDivObj.node.scrollLeft=0,this.contentDivObj=null,this.pagerObj&&this.node.removeChild(this.pagerObj.node),this.pagerObj=null,this.setupDataContentGrid(this.optObject),this.updateCheckBoxGroup(),this.setupEvent(),this.resize_colCopy(),this.columnDisplayCopy(),this.sinkScroll(),this.adjustTableScroll()},getDataPage:function(e){return e.dataSource?e.dataSource.read():null},setupEvent_cell:function(){var o=this,l="";Pudd.querySelectAll("td",this.contentTableObj.node).forEach(function(e,t){var i=Pudd.getInstance(e);i.cellEventSet||(i.cellEventSet=!0,i.on("mousedown",function(e){l=window.getSelection().toString()}),i.on("click",function(e){if(o.node.parentNode){if(o.optObject.clickCancelAtTextSelection){var t=window.getSelection().toString();if(l!=t)return e.preventDefault(),void e.stopPropagation()}if(o.switchRowClass(i),o.appendEditRecDiv(i,!1),i.column&&i.column.content&&"function"==typeof i.column.content.clickCallback){var n=i.parent();i.column.content.clickCallback.call(o,n.rowData,i.node,n.node,o)}o.gridRowClickCustomEvent(i)}}),i.on("dblclick",function(e){o.node.parentNode&&o.gridRowDblClickCustomEvent(i)}))})},setupEvent:function(){var n=this;this.contentTableObj&&(this.setupEvent_cell(),this.optObject.editable&&(this.eventKeydownSet||(this.eventKeydownSet=!0,Pudd.getInstance(document).on("keydown",function(e){n.node.parentNode&&n.eventKeydown(e)}))));this.optObject.editable?this.contentDivObj&&(this.contentDivObj.on("scroll",function(e){if(n.headerDivObj.node.scrollLeft=this.scrollLeft,n.lastCellObj){var t=n.getColumnEditType(n.lastCellObj);Pudd.Config.const.ID_COMBOBOX==t?n.editControls[n.lastCellObj.column.field].getDisplayListBox()&&n.editControls[n.lastCellObj.column.field].showListBox(!1,null):Pudd.Config.const.ID_DATEPICKER==t&&n.editControls[n.lastCellObj.column.field].getDisplayCalendar()&&n.editControls[n.lastCellObj.column.field].showCalendar(!1,null)}}),Pudd.getInstance(document).on("click",function(e){if(this.node.parentNode){var t=this.contentDivObj.offset(!0),n=e.clientX+document.documentElement.scrollLeft,i=e.clientY+document.documentElement.scrollTop;if(t.left<=n&&n<=t.right&&t.top<=i&&i<=t.bottom);else{if(this.changeComboBox)return void(this.changeComboBox=!1);if(this.changeDatePicker)return void(this.changeDatePicker=!1);this.switchRowClass(null),this.appendEditRecDiv(null,!1)}this.changeComboBox=!1,this.changeDatePicker=!1}}.bind(this))):this.contentDivObj&&this.contentDivObj.on("scroll",function(e){n.node.parentNode&&(n.headerDivObj.node.scrollLeft=this.scrollLeft)})},resize_setupEvent:function(){if(this.optObject.resizable&&this.headerTableObj){var a=Pudd.querySelectAll("col",this.headerTableObj.node);if(0!=a.length){a=a.filter(function(e){return"none"!=Pudd.getInstance(e).style("display")});var e=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1==e.length){var t=e[0],c=Pudd.querySelectAll("tr",t),h=this.resize_colRightArray(c);if(0!=h.length){var u=this.resize_colLeftArray(c);if(0!=u.length){var f=null,b=null,p=null,C=null,g=null;c.forEach(function(e,t){Pudd.querySelectAll("th",e).forEach(function(e,t){var l=Pudd.getInstance(e);if("none"!=l.style("display")){var n=this.resize_col_offset(l),i=n.right,o=h.indexOf(i);if(n.left==n.right){for(var s=-1,r=0;r<u.length;r++)if(n.left==u[r]){for(var d=0;d<h.length;d++)if(n.right==h[d]){s=r;break}break}if(-1==s)return;o=s}l.idxRightCol=o,l.on("mousedown",function(e){if(this.node.parentNode&&(h=this.resize_colRightArray(c),l.idxRightCol!=h.length-1)){var t=this.resize_col_offset(l);if(t){var n=parseInt(document.documentElement.scrollLeft,10),i=e.clientX+this.headerDivObj.node.scrollLeft+n;if(0<=t.right-i&&t.right-i<=5)b=l,f||((f=new Pudd.Util.TransView).setStyle=!1),f.showTransView(!0),f.setStyle||(f.setStyle=!0,f.transViewObj.style("cursor:col-resize;"));else if(0<=i-t.left&&i-t.left<=5){if(t.left==t.right)b=l;else{var o=this.resize_findLeftTarget(t.left);if(!o)return;if(o.idxRightCol+1!=l.idxRightCol)return;b=o}f||((f=new Pudd.Util.TransView).setStyle=!1),f.showTransView(!0),f.setStyle||(f.setStyle=!0,f.transViewObj.style("cursor:col-resize;"))}g=b?(p=this.resize_col_offset(b),C=a[b.idxRightCol].style.width,a[b.idxRightCol+1].style.width):C=p=null}}}.bind(this)),l.on("mousemove",function(e){if(this.node.parentNode&&l.idxRightCol!=h.length-1){var t=this.resize_col_offset(l);if(t){var n=parseInt(document.documentElement.scrollLeft,10),i=e.clientX+this.headerDivObj.node.scrollLeft+n;0<=t.right-i&&t.right-i<=5?l.style("cursor:col-resize;"):0<=i-t.left&&i-t.left<=5?l.style("cursor:col-resize;"):l.sortable?l.style("cursor:pointer;"):l.style("cursor:default;")}}}.bind(this))}}.bind(this))}.bind(this));var n=Pudd.getInstance(document);n.on("mousemove.gridresize",function(e){if(this.node.parentNode&&b){window.getSelection().removeAllRanges();var t=parseInt(document.documentElement.scrollLeft,10),n=e.clientX+this.headerDivObj.node.scrollLeft+t;if(n>h[b.idxRightCol+1]-16)return;var i=this.resize_col_offset(b);if(!i)return;if(n<i.left+16)return;this.resize_process_by_move(b,n,a,h,p,C,g)}}.bind(this)),n.on("mouseup.gridresize",function(e){this.node.parentNode&&(b&&(this.saveResizeRemember(),b=null),f&&f.showTransView(!1))}.bind(this))}}}}}},resize_col_offset:function(e){var t=e.offset(!0);return t?(t.left+=this.headerDivObj.node.scrollLeft,t.right+=this.headerDivObj.node.scrollLeft,t):null},resize_colLeftArray:function(e){var o=[];return e.forEach(function(e,t){Pudd.querySelectAll("th",e).forEach(function(e,t){var n=Pudd.getInstance(e);if("none"!=n.style("display")){var i=this.resize_col_offset(n).left;-1==o.indexOf(i)?o.push(i):n.column.width||o.push(i)}}.bind(this))}.bind(this)),o.sort(function(e,t){return e-t}),o},resize_colRightArray:function(e){var o=[];return e.forEach(function(e,t){Pudd.querySelectAll("th",e).forEach(function(e,t){var n=Pudd.getInstance(e);if("none"!=n.style("display")){var i=this.resize_col_offset(n).right;-1==o.indexOf(i)?o.push(i):n.column.width||o.push(i)}}.bind(this))}.bind(this)),o.sort(function(e,t){return e-t}),o},resize_findLeftTarget:function(o){var l=null,e=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1!=e.length)return null;var t=e[0];return Pudd.querySelectAll("tr",t).forEach(function(e,t){l||Pudd.querySelectAll("th",e).forEach(function(e,t){if(!l){var n=Pudd.getInstance(e);if("none"!=n.style("display")){var i=this.resize_col_offset(n);i.right-3<=o&&o<=i.right+3&&(l=n)}}}.bind(this))}.bind(this)),l},resize_findRightTarget:function(i){var o=null,e=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1!=e.length)return null;var t=e[0];return Pudd.querySelectAll("tr",t).forEach(function(e,t){Pudd.querySelectAll("th",e).forEach(function(e,t){var n=Pudd.getInstance(e);"none"!=n.style("display")&&(this.resize_col_offset(n).right==i&&(o=n))}.bind(this))}.bind(this)),o},resize_process_by_move:function(e,t,n,i,o,l,s){var r=e.idxRightCol;if(r!=i.length-1&&o){var d=t-i[r],a=Pudd.Fn.getNumberAndUnit(l);a||((a=[])[0]=i[r]-o.left+"px",a[1]=i[r]-o.left,a[2]=i[r]-o.left,a[5]="px");var c=Pudd.Fn.getNumberAndUnit(s);c||((c=[])[0]=i[r+1]-i[r]+"px",c[1]=i[r+1]-i[r],c[2]=i[r+1]-i[r],c[5]="px");var h=0;if(h=0<=d?this.resize_ratio_diff(i[r],i[r+1],d):this.resize_ratio_diff(o.left,i[r],d),"px"==a[5]){if("px"==c[5]){var u=0;u=0<=d?parseInt(c[1],10)*h/100:parseInt(a[1],10)*h/100,(m=Pudd.getInstance(n[r]))&&m.column&&!m.column.width||(n[r].style.width=parseInt(a[1],10)+parseInt(u,10)+"px"),(O=Pudd.getInstance(n[r+1]))&&O.column&&!O.column.width||(n[r+1].style.width=parseInt(c[1],10)-parseInt(u,10)+"px")}else if("%"==c[5]){var f=parseInt(a[1],10)+d,b=0;if(0<=d)b=parseFloat(c[1])-parseFloat(c[1])*h/100;else{var p=this.resize_ratio_diff(i[r],i[r+1],d);b=parseFloat(c[1])-parseFloat(c[1])*p/100}(m=Pudd.getInstance(n[r]))&&m.column&&!m.column.width||(n[r].style.width=f+"px"),(O=Pudd.getInstance(n[r+1]))&&O.column&&!O.column.width||(n[r+1].style.width=b+"%")}}else if("%"==a[5])if("px"==c[5]){var C=parseInt(c[1],10)-d,g=0;if(0<=d){var v=this.resize_ratio_diff(o.left,i[r],d);g=parseFloat(a[1])+parseFloat(a[1])*v/100}else g=parseFloat(a[1])+parseFloat(a[1])*h/100;(m=Pudd.getInstance(n[r]))&&m.column&&!m.column.width||(n[r].style.width=g+"%"),(O=Pudd.getInstance(n[r+1]))&&O.column&&!O.column.width||(n[r+1].style.width=C+"px")}else if("%"==c[5]){var m,O;u=0;u=0<=d?c[1]*h/100:a[1]*h/100,(m=Pudd.getInstance(n[r]))&&m.column&&!m.column.width||(n[r].style.width=parseFloat(a[1])+parseFloat(u)+"%"),(O=Pudd.getInstance(n[r+1]))&&O.column&&!O.column.width||(n[r+1].style.width=parseFloat(c[1])-parseFloat(u)+"%")}this.resize_colCopy()}},resize_process:function(e,t,n,i){var o=e.idxRightCol;if(o!=i.length-1){var l=this.resize_col_offset(e);if(l){var s=t-i[o],r=n[o].style.width,d=n[o+1].style.width,a=Pudd.Fn.getNumberAndUnit(r);a||((a=[])[0]=i[o]-l.left+"px",a[1]=i[o]-l.left,a[2]=i[o]-l.left,a[5]="px");var c=Pudd.Fn.getNumberAndUnit(d);c||((c=[])[0]=i[o+1]-i[o]+"px",c[1]=i[o+1]-i[o],c[2]=i[o+1]-i[o],c[5]="px");var h=0;if(h=0<=s?this.resize_ratio_diff(i[o],i[o+1],s):this.resize_ratio_diff(l.left,i[o],s),"px"==a[5]){if("px"==c[5]){var u=0;u=0<=s?parseInt(c[1],10)*h/100:parseInt(a[1],10)*h/100,(m=Pudd.getInstance(n[o]))&&m.column&&!m.column.width||(n[o].style.width=parseInt(a[1],10)+parseInt(u,10)+"px"),(O=Pudd.getInstance(n[o+1]))&&O.column&&!O.column.width||(n[o+1].style.width=parseInt(c[1],10)-parseInt(u,10)+"px")}else if("%"==c[5]){var f=parseInt(a[1],10)+s,b=0;if(0<=s)b=parseFloat(c[1])-parseFloat(c[1])*h/100;else{var p=this.resize_ratio_diff(i[o],i[o+1],s);b=parseFloat(c[1])-parseFloat(c[1])*p/100}(m=Pudd.getInstance(n[o]))&&m.column&&!m.column.width||(n[o].style.width=f+"px"),(O=Pudd.getInstance(n[o+1]))&&O.column&&!O.column.width||(n[o+1].style.width=b+"%")}}else if("%"==a[5])if("px"==c[5]){var C=parseInt(c[1],10)-s,g=0;if(0<=s){var v=this.resize_ratio_diff(l.left,i[o],s);g=parseFloat(a[1])+parseFloat(a[1])*v/100}else g=parseFloat(a[1])+parseFloat(a[1])*h/100;(m=Pudd.getInstance(n[o]))&&m.column&&!m.column.width||(n[o].style.width=g+"%"),(O=Pudd.getInstance(n[o+1]))&&O.column&&!O.column.width||(n[o+1].style.width=C+"px")}else if("%"==c[5]){var m,O;u=0;u=0<=s?c[1]*h/100:a[1]*h/100,(m=Pudd.getInstance(n[o]))&&m.column&&!m.column.width||(n[o].style.width=parseFloat(a[1])+parseFloat(u)+"%"),(O=Pudd.getInstance(n[o+1]))&&O.column&&!O.column.width||(n[o+1].style.width=parseFloat(c[1])-parseFloat(u)+"%")}this.resize_colCopy(),this.saveResizeRemember()}}},resize_ratio_diff:function(e,t,n){return 100*n/(t-e)},resize_colCopy:function(){var e=Pudd.querySelectAll("col",this.headerTableObj.node);if(0!=e.length){var t=Pudd.querySelectAll("col",this.contentTableObj.node);if(0!=t.length)for(var n=0;n<e.length;n++){var i=Pudd.getInstance(e[n]),o=Pudd.getInstance(t[n]);if(i&&i.column&&!i.column.width);else{var l=i.style("width");o.style("width",l)}}}},remove_resize_setupEvent:function(){if(this.optObject.resizable&&this.headerTableObj){var e=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1==e.length){var t=e[0];Pudd.querySelectAll("tr",t).forEach(function(e,t){Pudd.querySelectAll("th",e).forEach(function(e,t){var n=Pudd.getInstance(e);n.off("mousedown"),n.off("mousemove")})});var n=Pudd.getInstance(document);n.off("mousemove.gridresize"),n.off("mouseup.gridresize")}}},switchRowClass:function(e){this.optObject.hoverClick&&(Pudd.querySelectAll("tr",this.contentTableObj.node).forEach(function(e,t){Pudd.getInstance(e).removeClass("on")}),e&&e.parent().addClass("on"))},appendEditRecDiv:function(e,t){if(this.optObject.editable&&(!e||!e.editSelected)){if(this.lastCellObj){if(this.editRecObj){var n=this.getColumnEditType(this.lastCellObj);if(Pudd.Config.const.ID_TEXTBOX==n)this.lastCellObj.text(this.editControls[this.lastCellObj.column.field].val()),this.editRecChildSubObj.node.removeChild(this.editControls[this.lastCellObj.column.field].containerObj.node);else if(Pudd.Config.const.ID_COMBOBOX==n)this.lastCellObj.text(this.editControls[this.lastCellObj.column.field].text()),this.editRecChildSubObj.node.removeChild(this.editControls[this.lastCellObj.column.field].containerObj.node),this.editControls[this.lastCellObj.column.field].showListBox(!1,null);else if(Pudd.Config.const.ID_DATEPICKER==n)this.lastCellObj.text(this.editControls[this.lastCellObj.column.field].val()),this.editRecChildSubObj.node.removeChild(this.editControls[this.lastCellObj.column.field].containerObj.node),this.editControls[this.lastCellObj.column.field].showCalendar(!1,null);else for(;0<this.editRecChildSubObj.node.childNodes.length;)this.lastCellObj.append(this.editRecChildSubObj.node.childNodes[0])}this.lastCellObj.editSelected=!1,this.lastCellObj=null}if(e){this.createEditRecDiv();n=this.getColumnEditType(e);if(Pudd.Config.const.ID_TEXTBOX==n){this.createTextBox(e.column);var i=e.text().trim();this.editControls[e.column.field].val(i),e.node.innerHTML="",this.editRecChildSubObj.append(this.editControls[e.column.field].containerObj.node)}else if(Pudd.Config.const.ID_COMBOBOX==n){this.createComboBox(e.column);i=e.text().trim();e.node.innerHTML="",this.editRecChildSubObj.append(this.editControls[e.column.field].containerObj.node),this.mappingComboBoxControl(this.editControls[e.column.field],i)}else if(Pudd.Config.const.ID_DATEPICKER==n){this.createDatePicker(e.column);i=e.text().trim();e.node.innerHTML="",this.editRecChildSubObj.append(this.editControls[e.column.field].containerObj.node),this.mappingDatePickerControl(this.editControls[e.column.field],i)}else for(;0<e.node.childNodes.length;)this.editRecChildSubObj.append(e.node.childNodes[0]);e.append(this.editRecObj),e.editSelected=!0,this.lastCellObj=e,Pudd.Config.const.ID_TEXTBOX==n?this.editControls[e.column.field].node.select():Pudd.Config.const.ID_COMBOBOX==n?t?this.editControls[e.column.field].showListBox(!1,null):this.editControls[e.column.field].showListBox(!0,e):Pudd.Config.const.ID_DATEPICKER==n&&(t?this.editControls[e.column.field].showCalendar(!1,null):this.editControls[e.column.field].showCalendar(!0,e))}else this.removeEditRecDiv()}},eventKeydown:function(e){if(this.optObject.editable&&this.lastCellObj){var t=this.getColumnEditType(this.lastCellObj);if(e.keyCode==Pudd.Config.const.ID_KEYCODE_TAB)this.moveNextCellObj(this.lastCellObj,!1,!1,!0,!1)?e.preventDefault():window.setTimeout(function(){this.switchRowClass(null),this.appendEditRecDiv(null,!0)}.bind(this),10);else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ENTER){if(e.preventDefault(),Pudd.Config.const.ID_COMBOBOX==t){if(this.editControls[this.lastCellObj.column.field].getDisplayListBox())return}else if(Pudd.Config.const.ID_DATEPICKER==t&&this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;this.moveNextCellObj(this.lastCellObj,!1,!1,!0,!1)}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_SPACE)if(Pudd.Config.const.ID_TEXTBOX==t);else if(Pudd.Config.const.ID_COMBOBOX==t){if(e.preventDefault(),this.editControls[this.lastCellObj.column.field].getDisplayListBox())return;window.setTimeout(function(){this.editControls[this.lastCellObj.column.field].showListBox(!0,this.lastCellObj)}.bind(this),10)}else if(Pudd.Config.const.ID_DATEPICKER==t){if(e.preventDefault(),this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;window.setTimeout(function(){this.editControls[this.lastCellObj.column.field].showCalendar(!0,this.lastCellObj)}.bind(this),10)}else if(Pudd.Config.const.ID_CHECKBOX==t){e.preventDefault();var n=this.lastCellObj.checkboxObj.getChecked();this.lastCellObj.checkboxObj.setChecked(!n)}else e.preventDefault();else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_LEFT){if(Pudd.Config.const.ID_TEXTBOX==t){var i=this.editControls[this.lastCellObj.column.field].node.selectionStart,o=this.editControls[this.lastCellObj.column.field].node.selectionEnd;if(0!=i||0!=o)return}else if(Pudd.Config.const.ID_DATEPICKER==t&&this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;e.preventDefault(),this.moveNextCellObj(this.lastCellObj,!0,!1,!1,!1)}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_TOP){if(Pudd.Config.const.ID_COMBOBOX==t){if(this.editControls[this.lastCellObj.column.field].getDisplayListBox())return}else if(Pudd.Config.const.ID_DATEPICKER==t&&this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;e.preventDefault(),this.moveNextCellObj(this.lastCellObj,!1,!0,!1,!1)}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_RIGHT){if(Pudd.Config.const.ID_TEXTBOX==t){var l=this.editControls[this.lastCellObj.column.field].val().length;i=this.editControls[this.lastCellObj.column.field].node.selectionStart,o=this.editControls[this.lastCellObj.column.field].node.selectionEnd;if(l!=i||l!=o||i!=o)return}else if(Pudd.Config.const.ID_DATEPICKER==t&&this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;e.preventDefault(),this.moveNextCellObj(this.lastCellObj,!1,!1,!0,!1)}else if(e.keyCode==Pudd.Config.const.ID_KEYCODE_ARROW_BOTTOM){if(Pudd.Config.const.ID_COMBOBOX==t){if(this.editControls[this.lastCellObj.column.field].getDisplayListBox())return}else if(Pudd.Config.const.ID_DATEPICKER==t&&this.editControls[this.lastCellObj.column.field].getDisplayCalendar())return;e.preventDefault(),this.moveNextCellObj(this.lastCellObj,!1,!1,!1,!0)}}},moveNextCellObj:function(e,t,n,i,o){var l=this.getNextCellObj(e,t,n,i,o);return!!l&&(l.node.focus(),this.switchRowClass(l),this.appendEditRecDiv(l,!0),!0)},getNextCellObj:function(e,t,n,i,o){var l=null,s=e.parent(),r=this.contentTableObj.node.rows.length,d=s.node.cells.length,a=s.node.rowIndex,c=this.lastCellObj.node.cellIndex;if(t)if(0==c)if(0==a);else{var h=this.contentTableObj.node.rows[a-1],u=h.cells.length;l=Pudd.getInstance(h.cells[u-1])}else l=Pudd.getInstance(s.node.cells[c-1]);else n?0==a||(l=Pudd.getInstance(this.contentTableObj.node.rows[a-1].cells[c])):i?c==d-1?a==r-1||(l=Pudd.getInstance(this.contentTableObj.node.rows[a+1].cells[0])):l=Pudd.getInstance(s.node.cells[c+1]):o&&(a==r-1||(l=Pudd.getInstance(this.contentTableObj.node.rows[a+1].cells[c])));return l},getColumnEditType:function(e){return e.column&&e.column.editControl?this.getEditTypeCode(e.column.editControl.type):0},getEditTypeCode:function(e){if("string"==typeof e){if("textbox"==(e=e.toLowerCase().trim()))return Pudd.Config.const.ID_TEXTBOX;if("combobox"==e)return Pudd.Config.const.ID_COMBOBOX;if("datepicker"==e)return Pudd.Config.const.ID_DATEPICKER;if("checkbox"==e)return Pudd.Config.const.ID_CHECKBOX}return 0},createEditRecDiv:function(){if(!this.editRecObj){var e=document.createElement("div");this.editRecObj=new Pudd.Element(e),this.editRecObj.style("width:100%;height:100%;display:table;box-sizing:border-box;border:1px solid #007cc0;");var t=document.createElement("div");this.editRecChildObj=new Pudd.Element(t),this.editRecChildObj.style("vertical-align:middle;display:table-cell;background: #ffffff;");var n=document.createElement("div");this.editRecChildSubObj=new Pudd.Element(n),this.editRecChildSubObj.style("width:100%;text-align:center;"),t.appendChild(n),e.appendChild(t)}},removeEditRecDiv:function(){if(this.editRecObj){var e=this.editRecObj.parent();e&&e.node.removeChild(this.editRecObj.node)}},createTextBox:function(e){if(!this.editControls[e.field]){var t=document.createElement("input");t.setAttribute("type","text"),this.editControls[e.field]=new Pudd.Element.Control.TextBox(t),this.editControls[e.field].setup(e.editControl)}},createComboBox:function(t){if(!this.editControls[t.field]){var e=document.createElement("select");this.editControls[t.field]=new Pudd.Element.Control.ComboBox(e),this.editControls[t.field].setup(t.editControl),this.editControls[t.field].on("change",function(e){this.changeComboBox=!0,this.editControls[t.field].fieldObj.removeClass("on")}.bind(this))}},mappingComboBoxControl:function(e,t){for(var n=0;n<e.node.options.length;n++)if(t==e.node.options[n].textContent){e.node.selectedIndex=n,e.setSelectedOption();break}},createDatePicker:function(e){if(!this.editControls[e.field]){var t=document.createElement("input");t.setAttribute("type","text"),this.editControls[e.field]=new Pudd.Element.Control.DatePicker(t),this.editControls[e.field].setup(e.editControl),this.editControls[e.field].on("change",function(e){this.changeDatePicker=!0}.bind(this))}},mappingDatePickerControl:function(e,t){e.assignNewValue(t)},createCheckBox:function(e){var t=document.createElement("input");t.setAttribute("type","checkbox");var n=new Pudd.Element.Control.CheckBox(t);return n.setup(e.editControl),n},getGridData:function(){var n=[],l=this;return Pudd.querySelectAll("tr",this.contentTableObj.node).forEach(function(e,t){var o=Pudd.getInstance(e).rowData;o&&(Pudd.querySelectAll("td",e).forEach(function(e,t){var n=Pudd.getInstance(e),i=n.column;i.editControl&&Pudd.Config.const.ID_CHECKBOX==l.getEditTypeCode(i.editControl.type)&&i.field&&(o[i.field]={},o[i.field].value=n.checkboxObj.val(),o[i.field].checked=n.checkboxObj.node.checked)}),o.rowIndex=e.rowIndex,n.push(o))}),n},getGridDataCount:function(){var n=0;return Pudd.querySelectAll("tr",this.contentTableObj.node).forEach(function(e,t){Pudd.getInstance(e).rowData&&n++}),n},getTotalRowCount:function(){return this.contentTableObj.node.rows.length},addRow:function(e,t,n,i){if(("boolean"!=typeof i||i)&&1==this.contentTableObj.node.rows.length){var o=this.contentTableObj.node.rows[0];Pudd.getInstance(o).rowData||this.contentTableObj.node.deleteRow(0)}o=this.setupContentTable_tbody_tr(this.optObject,e);if("number"==typeof t)if(0<=t)if(n){var l=this.contentTableObj.node.rows[t];this.contentTableTbodyObj.node.insertBefore(o,l)}else{l=this.contentTableObj.node.rows[t+1];this.contentTableTbodyObj.node.insertBefore(o,l)}else this.contentTableTbodyObj.append(o);else this.contentTableTbodyObj.append(o);return this.setupEvent_cell(),o},showRow:function(e,t){if(!(t<0)){var n=this.contentTableObj.node.rows[t],i=Pudd.getInstance(n);e?i.style("display",null):i.hide()}},deleteRow:function(e){if("number"==typeof e)this.contentTableObj.node.deleteRow(e);else if(e&&"object"==typeof e&&e instanceof Array){for(var t=0;t<e.length;t++){var n=e[t],i=this.contentTableObj.node.rows[n];Pudd.getInstance(i).deleteSet=!0}var o=this;Pudd.querySelectAll("tr",this.contentTableObj.node).forEach(function(e,t){if(Pudd.getInstance(e).deleteSet){var n=e.rowIndex;o.contentTableObj.node.deleteRow(n)}})}this.updateCheckBoxGroup()},updateCheckBoxGroup:function(){if(this.checkControls){for(var e in this.checkControls)this.checkControls[e].content=[];var o=this;Pudd.querySelectAll("tr",this.contentTableObj.node).forEach(function(e,t){Pudd.getInstance(e).rowData&&Pudd.querySelectAll("td",e).forEach(function(e,t){var n=Pudd.getInstance(e),i=n.column;i.editControl&&Pudd.Config.const.ID_CHECKBOX==o.getEditTypeCode(i.editControl.type)&&i.field&&o.checkControls[i.field].content.push(n.checkboxObj)})})}},resetGridCheckBox:function(e,t){if(this.checkControls)for(var n in this.checkControls)if(n==e){this.checkControls[n].header.setChecked(t);var i=this.checkControls[n].content;if(i)for(var o=0;o<i.length;o++){!!i[o].attr("disabled")||i[o].setChecked(t)}}},disableGridCheckBox:function(e,t){if(this.checkControls)for(var n in this.checkControls)if(n==e){this.checkControls[n].header.setDisabled(t);var i=this.checkControls[n].content;if(i)for(var o=0;o<i.length;o++)i[o].setDisabled(t)}},gridRowClickCustomEvent:function(e){var t={};t.trObj=e.parent();var n=new CustomEvent("Event",{detail:t});n.initEvent("gridRowClick",!0,!0),this.node.dispatchEvent(n)},gridRowDblClickCustomEvent:function(e){var t={};t.trObj=e.parent();var n=new CustomEvent("Event",{detail:t});n.initEvent("gridRowDblClick",!0,!0),this.node.dispatchEvent(n)},gridHeight:function(e){if(this.optObject&&this.optObject.scrollable){if(null==e)return this.contentDivObj.style("height");this.contentDivObj.style("height",e+"px")}},gridColCount:function(){if(!this.contentTableObj)return 0;var e=Pudd.querySelectAll("colgroup",this.contentTableObj.node);return 1!=e.length?0:Pudd.querySelectAll("col",e[0]).length},moveRow:function(e,t){if("number"==typeof t&&(t=[t]),t&&"object"==typeof t&&t instanceof Array){if(0==t.length)return;var n=this.contentTableObj.node.rows.length;if(e){if(0==t[0])return}else if(n-1==t.slice(-1))return;if(e){for(var i=0,o=0;o<n;o++)if(o==t[i]){var l=this.contentTableObj.node.rows[o-1],s=this.contentTableObj.node.rows[o];if(this.contentTableTbodyObj.node.insertBefore(s,l),++i>=t.length)break}}else for(i=t.length-1,o=n-1;0<=o;o--)if(o==t[i]){s=this.contentTableObj.node.rows[o];var r=this.contentTableObj.node.rows[o+1];if(this.contentTableTbodyObj.node.insertBefore(r,s),--i<0)break}}this.updateCheckBoxGroup()},getGridSelectedRowObj:function(){var e=Pudd.querySelectAll("tr.on",this.contentTableObj.node);if(1!=e.length)return null;var t=Pudd.getInstance(e[0]);return t.rowData.rowIndex=t.node.rowIndex,t},getGridSelectedRowData:function(){var e=Pudd.querySelectAll("tr.on",this.contentTableObj.node);if(1!=e.length)return null;var t=Pudd.getInstance(e[0]),n=t.rowData;return n.rowIndex=t.node.rowIndex,n},getGridCheckedRowObj:function(e){var t=[];if(!this.checkControls)return t;if(0==Pudd.querySelectAll("tr",this.contentTableObj.node).length)return t;for(var n in this.checkControls)if(n==e){var i=this.checkControls[n].content;if(i)for(var o=0;o<i.length;o++)if(i[o].getChecked()){var l=i[o].tdObj.parent();l.rowData.rowIndex=l.node.rowIndex,t.push(l)}}return t},getGridCheckedRowData:function(e){var t=[];if(!this.checkControls)return t;if(0==Pudd.querySelectAll("tr",this.contentTableObj.node).length)return t;for(var n in this.checkControls)if(n==e){var i=this.checkControls[n].content;if(i)for(var o=0;o<i.length;o++)if(i[o].getChecked()){var l=i[o].tdObj.parent(),s=l.rowData;s.rowIndex=l.node.rowIndex,t.push(s)}}return t},getGridRowObj:function(e){var t=Pudd.querySelectAll("tr",this.contentTableObj.node);if(0==t.length)return null;if(t.length<=e)return null;var n=Pudd.getInstance(t[e]);return n?(n.rowData&&(n.rowData.rowIndex=n.node.rowIndex),n):null},getGridRowData:function(e){var t=Pudd.querySelectAll("tr",this.contentTableObj.node);if(0==t.length)return null;if(t.length<=e)return null;var n=Pudd.getInstance(t[e]),i=n.rowData;return i?(i.rowIndex=n.node.rowIndex,i):null},refresh:function(e){var t=this.optObject.dataSource.page,n=this.optObject.dataSource.pageSize,i=this.optObject.dataSource.sortField,o=this.optObject.dataSource.sortType;this.refreshGrid(t,n,i,o,e)},page:function(e,t){var n=this.optObject.dataSource.pageSize,i=this.optObject.dataSource.sortField,o=this.optObject.dataSource.sortType;this.refreshGrid(e,n,i,o,t)},showColumn:function(e){if("number"==typeof e)this.showColumnProcess(e,!1);else if("string"==typeof e){var t=this.getColumnIndexByField(this.optObject.columns,e);if(-1==t)return;this.showColumnProcess(t,!1)}},hideColumn:function(e){if("number"==typeof e)this.hideColumnProcess(e,!1);else if("string"==typeof e){var t=this.getColumnIndexByField(this.optObject.columns,e);if(-1==t)return;this.hideColumnProcess(t,!1)}},showColumnProcess:function(e,t){var n=this.getHeaderThObjByIndexCol(e);if(n&&(t||"none"==n.style("display"))){var i=this.getRelatedMultiThObjArr(e);if(i){for(var o=0;o<i.length;o++){var l=i[o].attr("colspan");if((l=parseInt(l,10))<=1)"none"==i[o].style("display")?i[o].style("display",null):i[o].attr("colspan",l+1);else i[o].attr("colspan",l+1)}n.style("display",null),this.setDisplayCol_HeaderAndContentByIndexCol(e,!0),this.setDisplayContentColumnByIndexCol(e,!0),this.remove_resize_setupEvent(),this.resize_setupEvent()}}},hideColumnProcess:function(e,t){var n=this.getHeaderThObjByIndexCol(e);if(n&&(t||"none"!=n.style("display"))){var i=this.getRelatedMultiThObjArr(e);if(i){if(0<i.length&&this.headerTableObj){var o=Pudd.querySelectAll("col",this.headerTableObj.node);if(0==o.length)return;if(o.length<=e)return;if("none"!=Pudd.getInstance(o[e]).style("display"))for(var l=0;l<i.length;l++){var s=i[l].attr("colspan");(s=parseInt(s,10))<=1?i[l].style("display:none;"):i[l].attr("colspan",s-1)}}n.style("display:none;"),this.setDisplayCol_HeaderAndContentByIndexCol(e,!1),this.setDisplayContentColumnByIndexCol(e,!1),this.remove_resize_setupEvent(),this.resize_setupEvent()}}},getHeaderThObjByIndexCol:function(e){var t=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1!=t.length)return null;for(var n=t[0],i=Pudd.querySelectAll("th",n),o=0;o<i.length;o++){var l=Pudd.getInstance(i[o]);if(l.idxCol==e)return l}return null},getRelatedMultiThObjArr:function(e){var t=Pudd.querySelectAll("thead",this.headerTableObj.node);if(1!=t.length)return null;for(var n=t[0],i=Pudd.querySelectAll("th",n),o=[],l=0;l<i.length;l++){var s=Pudd.getInstance(i[l]);void 0===s.idxCol&&s.idxStartCol<=e&&e<=s.idxEndCol&&o.push(s)}return o},setDisplayCol_HeaderAndContentByIndexCol:function(e,t){if(this.headerTableObj){var n=Pudd.querySelectAll("col",this.headerTableObj.node);if(0==n.length)return;if(n.length<=e)return;var i=Pudd.getInstance(n[e]);t?i.style("display",null):i.style("display:none;")}if(this.contentTableObj){var o=Pudd.querySelectAll("col",this.contentTableObj.node);if(0==o.length)return;if(o.length<=e)return;var l=Pudd.getInstance(o[e]);t?l.style("display",null):l.style("display:none;")}},setDisplayContentColumnByIndexCol:function(e,t){if(this.contentTableObj){var n=this.contentTableObj.node.rows.length;if(!(n<=0))for(var i=0;i<n;i++){if(Pudd.getInstance(this.contentTableObj.node.rows[i]).rowData){if(this.contentTableObj.node.rows[i].cells.length<=e)return;var o=this.contentTableObj.node.rows[i].cells[e],l=Pudd.getInstance(o);t?l.style("display",null):l.style("display:none;")}}}},getColumnIndexByField:function(e,t){for(var n=0;n<e.length;n++){var i=e[n],o=this.doGetColumnIndexByField(i,t);if(-1!=o)return o}return-1},doGetColumnIndexByField:function(e,t){if(e.columns&&0<e.columns.length){var n=this.getColumnIndexByField(e.columns,t);if(-1!=n)return n}else if(t==e.field)return e.idxCol;return-1},hideColumnSetup:function(){var e=[];this.hideColumnSetup_getHiddenColumn(this.optObject.columns,e);for(var t=0;t<e.length;t++){var n=e[t];if(void 0!==n.idxCol)this.hideColumnProcess(n.idxCol,!1);else{if(void 0===n.idxStartCol)continue;if(void 0===n.idxEndCol)continue;for(var i=n.idxStartCol;i<=n.idxEndCol;i++)this.hideColumnProcess(i,!1)}}},hideColumnSetup_getHiddenColumn:function(e,t){for(var n=0;n<e.length;n++){var i=e[n];this.hideColumnSetup_doGetHiddenColumn(i,t)}},hideColumnSetup_doGetHiddenColumn:function(e,t){e.columns&&0<e.columns.length?(1==e.hidden&&t.push(e),this.hideColumnSetup_getHiddenColumn(e.columns,t)):1==e.hidden&&t.push(e)},columnDisplayCopy:function(){if(this.headerTableObj&&this.contentTableObj){var e=Pudd.querySelectAll("col",this.headerTableObj.node);if(0!=e.length){var t=Pudd.querySelectAll("col",this.contentTableObj.node);if(0!=t.length&&e.length==t.length){for(var n=[],i=[],o=0;o<e.length;o++){var l=Pudd.getInstance(e[o]),s=Pudd.getInstance(t[o]),r=l.style("display");r!=s.style("display")&&(n.push(o),i.push(r))}for(o=0;o<n.length;o++)"none"==i[o]?this.hideColumnProcess(n[o],!0):this.showColumnProcess(n[o],!0)}}}},loadResizeRemember:function(){if(this.storage&&this.optObject.resizeRemember&&this.optObject.resizeRememberName){var e=this.storage.getItemJSON(this.optObject.resizeRememberName);if(e&&e.col&&e.col.length&&0!=e.col.length){var t=Pudd.querySelectAll("col",this.headerTableObj.node);if(0!=t.length&&e.col.length==t.length){for(var n=0;n<t.length;n++)if(e.col[n].width){var i=Pudd.getInstance(t[n]);i&&i.column&&!i.column.width||i.style("width",e.col[n].width)}this.resize_colCopy()}}}},saveResizeRemember:function(){if(this.storage&&this.optObject.resizeRemember&&this.optObject.resizeRememberName){var e=Pudd.querySelectAll("col",this.headerTableObj.node);if(0!=e.length){for(var t={col:[]},n=0;n<e.length;n++){var i=Pudd.getInstance(e[n]).style("width");t.col[n]={},t.col[n].width=i}this.storage.setItemJSON(this.optObject.resizeRememberName,t)}}},getColumnsByCol:function(){var e=Pudd.querySelectAll("col",this.headerTableObj.node);if(0==e.length)return[];for(var t=[],n=0;n<e.length;n++){var i=Pudd.getInstance(e[n]),o={};o.field=void 0===i.column.field?"":i.column.field,o.title=void 0===i.column.title?"":i.column.title,o.show=!0,"none"==i.style("display")&&(o.show=!1),t.push(o)}return t},sinkScroll:function(){this.optObject&&this.optObject.height&&this.contentDivObj&&(this.contentDivObj.node.scrollHeight,this.contentDivObj.node.clientHeight)},adjustTableScroll:function(){if(this.headerTableObj&&(this.contentTableObj&&navigator.userAgent.match(/Mac|PPC/))){Pudd(".grid-header",this.node).style("margin-right","0"),Pudd(".grid-footer",this.node).style("margin-right","0"),Pudd(".rightHeader",this.node).style("margin-right","0");var e=this.headerTableObj.node.clientWidth,t=this.contentTableObj.node.clientWidth;if(0==this.contentTableObj.node.rows.length)return;if(0==t)return;if(0==this.getGridDataCount())return;if(e==t);else if(t<e){var n=e-t;Pudd(".grid-header",this.node).style("margin-right",n+"px"),Pudd(".grid-footer",this.node).style("margin-right",n+"px"),Pudd(".rightHeader",this.node).style("margin-right",n+"px")}}}}});
Pudd.Element.Component.Pager=Pudd.invent({init:function(t){this.pageVal=null,this.lastPageVal=null,this.numberObjArr=null,this.pageListObj=null,this.firstBtnObj=null,this.prevBtnObj=null,this.nextBtnObj=null,this.lastBtnObj=null,this.refVal=null,this.constructor.call(this,t)},inherit:Pudd.Element.Component,extend:{setup:function(t){return this.setupContainer(),this.addClass(Pudd.Config.className.PUDD_UI_pager),this.optObject=this.parseOption(t),this.numberObjArr=[],this.setupPagingNumber(this.optObject),this.setupPageList(this.optObject),this.setupRefVal(this.optObject),this.setupEvent(),this},parseOption:function(t){if(t)t.page=this.getPositiveNumber(t.page,1),t.totalCount=this.getPositiveNumber(t.totalCount,null),t.buttonCount=this.getPositiveNumber(t.buttonCount,10),t.pageSize=this.getPositiveNumber(t.pageSize,10),t.pageList=t.pageList instanceof Array?t.pageList:null,t.ref="string"==typeof t.ref?t.ref:"";else{t={};var e=this.attr("pudd-pager-page");t.page=e&&"string"==typeof e?this.getPositiveNumber(e.trim(),10):1;var n=this.attr("pudd-pager-total-count");t.totalCount=n&&"string"==typeof n?this.getPositiveNumber(n.trim(),10):null;var a=this.attr("pudd-pager-button-count");t.buttonCount=a&&"string"==typeof a?this.getPositiveNumber(a.trim(),10):10;var i=this.attr("pudd-pager-page-size");t.pageSize=i&&"string"==typeof i?this.getPositiveNumber(i.trim(),10):10;var s=this.attr("pudd-pager-page-list");if(s&&"string"==typeof s){var l=s.split(",");if(0<l.length){for(var r in l)l[r]=parseInt(l[r].trim(),10);t.pageList=l}}else t.pageList=null;var p=this.attr("pudd-pager-ref");t.ref=p&&"string"==typeof p?p.trim():""}return t},setupPagingNumber:function(t){var e=document.createElement("div");e.className="paging",this.append(e);var n=t.page,a=this.calculatePagingNumber(t),i=document.createElement("span");this.firstBtnObj=new Pudd.Element(i),i.className=1!=n?"first":"first disabled",e.appendChild(i),this.appendAnchorNode(i,"first"),this.appendChildTextNode(e," ");i=document.createElement("span");if(this.prevBtnObj=new Pudd.Element(i),i.className=1!=n?"pre":"pre disabled",e.appendChild(i),this.appendAnchorNode(i,"prev"),this.appendChildTextNode(e," "),t.buttonCount&&0<t.buttonCount){var s=document.createElement("ol");e.appendChild(s);for(var l=a.stratNo;l<=a.endNo;l++){var r=document.createElement("li");s.appendChild(r),l==n&&(r.className="on",this.pageVal=l);var p=document.createElement("a");r.appendChild(p);var o=new Pudd.Element(p);o.attr("href","javascript:;"),o.text(l),o.no=l,this.numberObjArr.push(o)}this.appendChildTextNode(e," ")}i=document.createElement("span");this.nextBtnObj=new Pudd.Element(i),n<this.lastPageVal?i.className="nex":i.className="nex disabled",e.appendChild(i),this.appendAnchorNode(i,"next"),this.appendChildTextNode(e," ");i=document.createElement("span");this.lastBtnObj=new Pudd.Element(i),n<this.lastPageVal?i.className="last":i.className="last disabled",e.appendChild(i),this.appendAnchorNode(i,"last"),this.appendChildTextNode(e," ")},calculatePagingNumber:function(t){if(t.buttonCount&&0<t.buttonCount){var e=parseInt(t.page/t.buttonCount,10),n=null,a=(n=0==t.page%t.buttonCount?t.buttonCount*(e-1)+1:t.buttonCount*e+1)+t.buttonCount-1;if(null!=t.totalCount&&0<t.totalCount){var i=parseInt(t.totalCount/t.pageSize,10),s=null;(s=0==t.totalCount%t.pageSize?i:i+1)<a&&(a=s),this.lastPageVal=s}return{stratNo:n,endNo:a}}return null},appendAnchorNode:function(t,e){var n=document.createElement("a");return n.textContent=e,n.href="javascript:;",t.appendChild(n),n},appendChildTextNode:function(t,e){var n=document.createTextNode(e);return t.appendChild(n),n},setupPageList:function(t){var e=document.createElement("div");if(e.className="gt_count",this.append(e),t.pageList){var n=document.createElement("select");e.appendChild(n),this.pageListObj=new Pudd.Element.Control.ComboBox(n),this.pageListObj.style("width:50px;");var a=0;for(var i in t.pageList){var s=t.pageList[i],l=document.createElement("option");l.value=s,l.textContent=s,t.pageSize==s&&(a=i),this.pageListObj.append(l)}this.pageListObj.node.selectedIndex=a,this.pageListObj.setup()}},setupRefVal:function(t){this.refVal=t.ref},setupEvent:function(){var n=this;this.firstBtnObj&&this.firstBtnObj.on("click",function(t){Pudd.getInstance(this).hasClass("disabled")||n.pagerCustomEvent("first",null)}),this.prevBtnObj&&this.prevBtnObj.on("click",function(t){Pudd.getInstance(this).hasClass("disabled")||n.pagerCustomEvent("prev",null)}),this.nextBtnObj&&this.nextBtnObj.on("click",function(t){Pudd.getInstance(this).hasClass("disabled")||n.pagerCustomEvent("next",null)}),this.lastBtnObj&&this.lastBtnObj.on("click",function(t){Pudd.getInstance(this).hasClass("disabled")||n.pagerCustomEvent("last",null)}),this.numberObjArr.forEach(function(t,e){t.on("click",function(t){var e=Pudd.getInstance(this);n.pagerCustomEvent(null,e.no)})}),this.pageListObj&&this.pageListObj.on("change",function(t){var e=Pudd.getInstance(this).val();n.pagerCustomEvent(null,null,e)})},pagerCustomEvent:function(t,e){var n={first:!1,prev:!1,next:!1,last:!1,page:null,pageSize:null};n.ref=this.refVal,n.lastPage=this.lastPageVal,t&&(n.first="first"==t,n.prev="prev"==t,n.next="next"==t,n.last="last"==t,n.page=this.pageVal),e&&(n.page=e),this.pageListObj&&this.optObject.pageList&&0<this.optObject.pageList.length?n.pageSize=parseInt(this.pageListObj.val(),10):n.pageSize=this.optObject.pageSize;var a=new CustomEvent("Event",{detail:n});a.initEvent("pagerClick",!0,!0),this.node.dispatchEvent(a)}}});
...
Pudd.Util.ToolTip=Pudd.invent({init:function(){this.parentObj=null,this.toolTipObj=null,this.alwaysShow=!0,this.showAtClientX=!1,this.constructor.call(this)},inherit:Pudd.Util,extend:{initToolTip:function(t,i){this.setupToolTip(i),t&&(this.appendToolTip(t),this.eventToolTip())},setPropAlwaysShow:function(t){this.alwaysShow=t},setPropShowAtClientX:function(t){this.showAtClientX=t},setupToolTip:function(t){var i=document.createElement("div");i.innerHTML=t;var o=document.createElement("span");o.className="arrow",i.appendChild(o),this.toolTipObj=new Pudd.Element(i),this.toolTipObj.addClass("toolTip"),this.toolTipObj.hide()},appendToolTip:function(t){this.parentObj=Pudd.getInstance(t),this.parentObj.append(this.toolTipObj)},eventToolTip:function(){this.parentObj&&this.toolTipObj&&(this.parentObj.on("mouseenter",function(t){if(!this.alwaysShow){if(this.parentObj.node.scrollWidth<this.parentObj.node.offsetWidth+1)return}var i=this.parentObj.node.getBoundingClientRect();if(this.toolTipObj.style("top:"+(i.bottom+9)+"px"),this.showAtClientX){var o=t.clientX-12;o<0&&(o=0),this.toolTipObj.style("left:"+o+"px")}else this.toolTipObj.style("left:"+i.left+"px");this.toolTipObj.addClass("animated03s"),this.toolTipObj.addClass("fadeInUp"),this.toolTipObj.show(),window.setTimeout(function(){this.toolTipObj.removeClass("animated03s"),this.toolTipObj.removeClass("fadeInUp")}.bind(this),300)}.bind(this)),this.parentObj.on("mouseout",function(t){this.toolTipObj.hide()}.bind(this)),this.parentObj.on("mousewheel",function(t){this.toolTipObj.hide()}.bind(this)))}}});
