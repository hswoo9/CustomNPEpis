...
<script type="text/javascript">
	...
	function gridReload() {
		...
		form.action = "${pageContext.request.contextPath}/budget/bgtBudgetList";
	...
	function gridExcel() {
		...
		var form = document.budgetForm;
		form.action = "${pageContext.request.contextPath}/budget/bgtBudgetListExcel";
...
<body>
	...
	<div class="iframe_wrap" style="min-width: 1070px;">
		<form id="budgetForm" name="budgetForm" action="${pageContext.request.contextPath}/budget/bgtBudgetList" method="post">
		...
		<div class="sub_contents_wrap">
			<p class="tit_p mt5 mt20">예산과목별 예산편성 현황</p>
			<div class="top_box">
				<dl>				    
