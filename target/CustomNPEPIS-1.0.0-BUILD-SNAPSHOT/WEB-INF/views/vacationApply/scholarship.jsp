...
var $familyInfo = JSON.parse('${familyInfo}').list;
// debugger
...
// 			$("#target_relationship").val(data.family_relationship);
...
// 						education_type_name : $("#scholarship").data("kendoDropDownList").text(),
					...
					target_birth : $("#target_birth").val().replace(/-/gi,''),
...
// 					param.data = JSON.stringify(data);
				...
				param.status = "update";
				param.education_expense_id = $education_expense_id;
// 					var data = [];
// 					$(".personDetail").each(function(i,v){
// 						var list = {};
				...
				success : function(result){
					...
					if(sep == 'click'){
						if(result.status == "insert"){
							...
							formData.append('target_table_name','scholar_file_attach');
							formData.append('target_id',result.education_expense_id);
							$.ajax({
								url: _g_contextPath_ + '/vacationApply/scholarApplyFileSave',
								type: 'post',
								dataType: 'json',
								data: formData,
								cache: false,
	...
	<div class = "pop_con">
		<div class = "top_box">
			...
			<dl class = "next2">
				<dt>대상자 생년월일</dt>
				<dd>
					<input type="text" id = "target_birth" style = "width:120px;text-align:center;" />
				</dd>

				<dt>관계</dt>
				<dd>
					<input type="text" id = "target_relationship" class="popInput" style="width:120px;text-align:center;"/>
				</dd>
			</dl>
			<dl class="next2">
...
<%-- 					<img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="checkIcon" /> --%>
			...
			<dl class="next2">
				<dt>증빙서류</dt>
				<dd>
					<input type="text" id="fileID1" class="file_input_textbox clear popInput" style="width:320px;" readonly="readonly" placeholder="파일 선택" /> 
