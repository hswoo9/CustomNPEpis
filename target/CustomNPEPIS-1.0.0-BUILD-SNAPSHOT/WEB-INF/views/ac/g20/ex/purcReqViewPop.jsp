...
$(function(){
	...
	$('#returnReason, #btnReturn, #btnApproval').prop('disabled', false);
	if($("#reqState").val() == "003"){
		$('.title_NM').html($('#purcReqType').val().replace('의뢰서','의뢰접수'));
	}else{
		$('.title_NM').html($('#purcReqType').val());
	}
	
	if($("#contTypeCodeId").val() == "002"){
		$(".contType2").show();
	}
});
		...
		<div class="psh_btnbox">
			...
			<div class="psh_right">
				<div class="btn_cen mt8">
					<span style="margin-top: 3px;margin-right: 20px;float: left;">
						<span style="color: #fff;">반려사유</span>	
						<input type="text" id="returnReason" style="width: 400px;">
					</span>
				    <input type="button" class="psh_btn" id="btnReturn" value="반려" />
...
<!-- 							</td> -->
						...
						<tr class="contType2" style="display:none;">
							...
							<th>거래처</th>
							<td colspan="3" id="purc-trade-td" class="le">
