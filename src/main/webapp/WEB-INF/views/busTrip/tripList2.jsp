	...
	var dataSource = new kendo.data.DataSource({
		transport: {
			read: {
				type: 'post',
				dataType: 'json',
				url: _g_contextPath_ + "/busTrip/getonNaraBTListOutside",
			},
			...
			columns : [
						...
						columns : [
							...
							columns : [
								...
								width:100,
								template: function(data){
									var traficCost = data.trafic_cost || 0;
									var dayCost = data.day_cost || 0;
									var etcCost = data.etc_cost || 0;
									var foodCost = data.food_cost || 0;
									var roomCost = data.room_cost || 0;
									
									var total = traficCost+dayCost+etcCost+foodCost+roomCost;
									
									return total.toString().toMoney();
								}
							}
						]
						} ,{
						...
						dataBound : function (e) {
								...
								if(grid.dataSource._data.length==0){
									...
									var colCount = 22; //다중 컬럼이다보니 숫자를 강제로 세어서 넣오줌
									$(e.sender.wrapper)
										.find('tbody')
	...
	<div class="sub_contents_wrap">
		...
		<div class="top_box">
			<dl>
				...
				<dd>
					<input type="text" name="" id="txtTitle" style="width: 150px;" readonly="readonly" class="ri"/>
