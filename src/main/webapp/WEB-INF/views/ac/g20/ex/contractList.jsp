...
function mainGrid(){
	...
	var grid = $("#grid").kendoGrid({
        dataSource: new kendo.data.DataSource({
            ...
            transport: { 
                read:  {
                    url: _g_contextPath_+'/Ac/G20/Ex/getMainGrid',
                    dataType: "json",
                    type: 'post'
                },
        ...
        /* {
            ...
            template: function(data){
            	return "<a style='color: rgb(0, 51, 255);' href='javascript:fnDocPopOpen(\""+data.purc_cont_id+"\",\""+data.c_dikeycode+"\");'>"+data.c_ridocfullnum+"</a>";
            },
            width: 100
        },{
        	field: "cont_title",
            title: "계약명",
            template: function(data){
            	return "<a style='color: rgb(0, 51, 255);' href='javascript:fnPurcContViewPop(\""+data.purc_req_id+"\",\""+data.purc_req_type_code_id+"\",\""+data.form_id+"\",\""+data.purc_cont_id+"\");'>"+data.cont_title+"</a>";
            },
            width: 120
        },{
        	field: "requester_emp_name",
            title: "담당자",
            width: 60
        },{
        	field: "requester_dept_name",
        	title: "부서",
        	width: 50
        },{
        	field: "mgt_nm",
...
//         	width: 70
        	...
        	field: "cont_date",//"cont_start_date",
        	title: "착수일",
			width: 65
        },{
        	field: "cont_end_date",
	...
	action="${pageContext.request.contextPath }/shiftWorker/shiftWkReqInsert">
		...
		<div class="top_box gray_box">
			<dl>
				...
				<dd>
					<input type="text" id="searchDt" style="width:100px;text-align:center;">
				</dd>
