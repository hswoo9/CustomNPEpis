...
// 					erp_emp_num : "${userInfo.erpEmpSeq}", 
// 					dept_seq : "${userInfo.deptSeq}", 
...
// 			}
	...
	function deleteRow(){	//삭제함수
		...
		if(!dataItem){
			...
			//상태값이 미상신 진행중 취소(안할것같음) 일때만 삭제가능하도록 처리
			if(status == '미상신' || status == '(진행중)임시저장'){
				//ajax로 넘겨서 삭제처리 active 'N'
				...
				},
				{
					template : function(dataItem){	//진행상태가 미상신일때만 수정가능(더블클릭이벤트설정) 
							if(dataItem.education_expense_id != undefined || dataItem.education_expense_id != null){
								if(dataItem.status_name == '미상신'){
									return "<span class = 'education_expense_id' ondblclick = 'dbclickToApply()'>"+dataItem.education_expense_id+"</span>"
								}else if(dataItem.status_name == '진행중(임시저장)'){
									return "<span class = 'education_expense_id' ondblclick = 'approval()'>"+dataItem.education_expense_id+"</span>"
								}else{
...
<!-- 					<button type="button" id="approvalChk" onclick = "approvalChk()">결재보기</button> -->
					...
					<button type="button" id="apply" onclick = "apply()">신청</button>
				</div>
			</div>
		</div>
		<div class="com_ta">
			<div class="top_box gray_box" id = "dataBox">
				<dl>
					<dt>
						<img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" />신청일자
					</dt>
					<dd>
	...
	<div class = "pop_con">
		<div class = "top_box">
			<dl>
				<dt class = "ar">신청일자</dt>
				<dd>
					<input type="text" id = "apply_date" style = "width:120px;" value="${nowDate}" disabled/>
				</dd>
				<dt>
					<img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="checkIcon" />대상자
				</dt>
				<dd>
					<input type = "text" id = "target_name" check="must" class="popInput" style="width:122px; heigth: 24px;">
					</input>
				</dd>
			...
			<dl class = "next2">
				<dt>
					<img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="checkIcon" />교육기관
				</dt>
				<dd>
					<input type="text" id = "education_institution" class="popInput" check="must" style = "width:120px;"/>
				</dd>
<!-- 				<dt> -->
...
<!-- 				</dd> -->
				...
				<dt style="text-align:right;">관계</dt>
				<dd>
					<input type="text" id = "target_relationship" class="popInput" style="width:120px;"/>
				</dd>
			</dl>
			...
			<dl class="next2">
				...
				<dd>
					<input type="text" id = "education_grade" class="popInput" check="must" style = "width:120px;"/>
				</dd>
				<dt style=" text-align:right;">신청학기</dt>
				<dd>
					<select id = "education_term" style = "width:120px;">
			...
			<dl class="next2">
				...
				<dt>신청금액</dt>
				<dd>
					<input type="text" id = "education_sum_money" class="popInput" style = "width:120px;" readonly/>
				</dd>
				<dt>비고</dt>
				<dd>
					<input type="text" id = "remark" class="popInput" style = "width:120px;" />
...
<!-- 				<dt>비고</dt> -->
<!-- 				<dd> -->
<!-- 					<input type="text" id = "remark" class="popInput" style = "width:380px;" /> -->
<!-- 					<input type="hidden" id = "scholarship" style="width:122px;" value="학자금"> -->
<!-- 				</dd> -->
<!-- 			</dl> -->
		</div>
...
<!-- 			</div> -->
		...
		<div class = "top_box mt5">
			<dl class="bg_skyblue2" style="background-color: #CEF6F5">
				<dt class="ml0" style="width: 150px">
...
<!-- 				<dt style="width:50px">&nbsp;</dt> -->
	...
	<div class = "pop_foot">
		<div class = "btn_cen pt12">
			<input type="button" class = "blue_btn" id = "save" onclick="save('click')" value="저장"/>
