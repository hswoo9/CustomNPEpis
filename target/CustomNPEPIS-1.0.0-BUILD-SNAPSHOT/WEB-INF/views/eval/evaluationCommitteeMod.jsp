			...
			<div class="top_box gray_box">
				<dl>
					...
					<dd style="line-height: 25px; margin-left: 44px;">
						<input type="radio" name="gender" class="chkData" id="genderM" value="남" <c:if test="${pool.gender eq '남'}">checked</c:if> /><label for="genderM" style="margin-right: 7px;">남</label>
						<input type="radio" name="gender" class="chkData" id="genderF" value="여" <c:if test="${pool.gender eq '여'}">checked</c:if> /><label for="genderF">여</label>
					</dd>
				</dl>
				...
				<dl>
					...
					<dt style="margin-left:200px;">
						...
						<input type="text" id="job_type" name="job_type" readonly="readonly" style="width: 300px;" value="${detail.job_type }">
					</dt>
				</dl>
				...
				<dl>
					...
					<dd style="line-height: 25px">
						<select id="bankCode" style="width: 150px;">
							...
							<c:forEach var="list" items="${bankList }">
								<option value="${list.BANK_CD }" ${detail.bank_cd == list.BANK_CD ? 'selected="selected"' : '' }>${list.BANK_NM }</option>
							</c:forEach>
						</select>
					</dd>
					...
					<dd style="line-height: 25px; padding-left: 25px;">
						...
						<input type="text" name="bank_no" style="width: 250px;" value="${detail.bank_no}">
					</dd>
						...
						<div class="com_ta" style="width: 750px;">
							<div class="top_box gray_box">
								<dl>
									...
									<dd style="line-height: 25px">
										<input type="text" name="org_dept" style="" value="${detail.org_dept }" />
									</dd>
								</dl>
								<dl>
									<dt style="width: 60px;">
...
function vcApply(){
	...
	for (var i = 0; i < $('.chkData').length; i++) {
		...
		if($(chkInput[i]).val().length == 0 || !$('input[name=gender]:checked')){
