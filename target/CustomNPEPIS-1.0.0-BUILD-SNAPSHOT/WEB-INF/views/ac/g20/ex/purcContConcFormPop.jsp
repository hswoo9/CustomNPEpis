...
// 		$('.purcReqType2hide').show();
	...
	$('.title_NM').html($('#purcReqType').val().replace('의뢰서','계약체결'));
	
	ctlBudgetHide(12);
	ctlBudgetHide(10);
	if($("#contType").attr("code") == "002"){
		$("img", $("#fileArea_cont2").closest("tr")).hide();
	}
});
        ...
        <table id="erpBudgetInfo-tablesample" style="display:none">
		    <tr class="">
		        ...
		        <td width="200" id="budget-td">
		            <input type="text" style="width:45%;" id="txt_BGTNM_REF" class="non-requirement" readonly="readonly" />
		            <input type="text" style="width:45%;" id="txt_BUDGET_LIST"  class="requirement" tabindex="10001" readonly="readonly" />
		...
		<div id="purcContInfo2">
			<div  class="com_ta2 hover_no mt10">
				<table>
					...
					<tbody>
						<tr>
							<th><img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" /> 계약일</th>
							<td class="le">
								<input type="text" id="contDate2" style="width: 100px;"/>
							</td>
							<th><img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" /> 계약기간</th>
							<td class="le" colspan="2">
								<input type="text" id="contStartDate2" style="width: 100px;"/> ~
								<input type="text" id="contEndDate2" style="width: 100px;"/>
							</td>
						</tr>
						<tr>
							<th><img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" /> 계약서</th>
							<td id="fileArea_cont2" class="le" colspan="3">
							</td>
							<td>
						...
						<tr>
							<th>첨부파일</th>
							<td id="fileArea_cont3" class="le" colspan="3">
							</td>
							<td>
