...
<div class="iframe_wrap" style="min-width:1100px">
	...
	<div class="sub_contents_wrap" style="min-width:1400px; min-height: 0px;">
		<div class="left_div">
			<p class="tit_p mt5 mb10">제안평가 목록</p>
		</div>
...
var gridModBtn = function(row){
	...
	if(row.final_approval_active == 'N') {
		return '<input type="button" value="상세" onclick="gridDetail(this);"> <input type="button" value="삭제" onclick="gridDel(this);"> <input type="button" id="finalApproval" value="최종승인" onclick="gridConfirm(this);">';;
	} else {
		return '<input type="button" value="상세" onclick="gridDetail(this);"> <input type="button" value="삭제" onclick="gridDel(this);"> <input type="button" id="finalApproval" value="최종승인 취소" onclick="gridConfirm(this);">';
	}
}
// var gridModBtn = function(row){
...
function gridConfirm(e){
	...
	$.ajax({
		url : "<c:url value='/eval/finalApprovalActiveSave' />",
		data : {code : row.committee_seq, final_approval_active : active},
		type : 'POST',
		success : function(result) {
