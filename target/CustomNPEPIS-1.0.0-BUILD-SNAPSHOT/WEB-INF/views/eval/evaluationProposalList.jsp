...
if (String(emp_seq) == "1" || String(emp_seq) == "1397" || String(emp_seq) == "1299" || String(emp_seq) == "1385" || String(emp_seq) == "1246" || String(emp_seq) == "1266") {
...
var stepTemp = function(row){
	...
	console.log(row.final_approval_active);
	console.log(resultList.length);
	console.log(row.step);
	if (Number(resultList.length) > Number(0)) {
		console.log(resultList[0].eval_pay);
	}
...
var gridModBtn = function(row){
	...
	if(row.final_approval_active == 'N') {
		return '<input type="button" value="상세" onclick="gridDetail(this);"> <input type="button" value="삭제" onclick="gridDel(this);">';
	} else {
		return '<input type="button" value="상세" onclick="gridDetail(this);"> <input type="button" value="삭제" onclick="gridDel(this);">';
	}
}
